...
import { TableIdentifier } from './types';
/**
 ...
 */
export declare function renameTable(this: Compiler, filepath: Filepath, oldName: string | TableIdentifier, newName: string | TableIdentifier): Map<string, string>;
