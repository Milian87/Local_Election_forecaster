...
import { default as Compiler } from '..';
/**
...
export declare function normalizeQualifiedName(...parts: string[]): string;
/**
...
export declare function collectTransitiveDependencies(compiler: Compiler, entrypoints: Filepath[]): Filepath[];
export declare function allVisibleMembers(compiler: Compiler): Report<NodeSymbol[]>;
/**
 * Wraps a note value in the appropriate DBML quote style.
 * Uses triple quotes for multiline content, single quotes otherwise.
 */
export declare function quoteNoteValue(value: string): string;
