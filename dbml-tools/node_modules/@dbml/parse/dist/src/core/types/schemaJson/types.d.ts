...
export declare const DEP_DOWNSTREAM: "->";
export declare const DEP_UPSTREAM: "<-";
...
export type MetadataValues = Record<string, {
    value: string;
    token: TokenPosition;
}>;
...
export type SchemaElement = Database | Project | Table | Note | Column | ColumnType | Index | Check | InlineRef | InlineDep | Ref | RefEndpoint | Dep | DepEdge | DepEndpoint | Enum | EnumField | TableGroup | TableGroupField | Alias | TablePartial | TablePartialInjection | TableRecord | RecordValue | MetadataValues;
