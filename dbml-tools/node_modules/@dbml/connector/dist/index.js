Object.defineProperty(exports,Symbol.toStringTag,{value:`Module`});var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(e&&(t=e(e=0)),t),s=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),c=(e,n)=>{let r={};for(var i in e)t(r,i,{get:e[i],enumerable:!0});return n||t(r,Symbol.toStringTag,{value:`Module`}),r},l=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},u=(n,r,a)=>(a=n==null?{}:e(i(n)),l(r||!n||!n.__esModule?t(a,`default`,{value:n,enumerable:!0}):a,n)),d=e=>a.call(e,`module.exports`)?e[`module.exports`]:l(t({},`__esModule`,{value:!0}),e);let f=require("@google-cloud/bigquery"),p=require("fs/promises"),m=require("mssql");m=u(m);let h=require("oracledb");h=u(h);let g=require("pg"),_=require("snowflake-sdk");_=u(_);async function v(e){try{return await(0,p.readFile)(e,{encoding:`utf8`})}catch(e){throw e.name===`TypeError`||e.name===`Error`?Error(`Load credential error: ${e.message}`):e}}function y(e){try{let{project_id:t,client_email:n,private_key:r,datasets:i}=JSON.parse(e),a={datasets:Array.isArray(i)?i.filter(e=>typeof e==`string`):[]};if(t!==void 0){if(typeof t!=`string`||!t||!t.trim())throw Error(`project_id must be a non-empty string when provided`);a.projectId=t}if(n!==void 0||r!==void 0){if(!n||typeof n!=`string`||!n.trim())throw Error(`client_email must be a non-empty string when credentials are provided`);if(!r||typeof r!=`string`||!r.trim())throw Error(`private_key must be a non-empty string when credentials are provided`);a.credentials={clientEmail:n,privateKey:r}}return a}catch(e){throw e instanceof SyntaxError?Error(`Credentials must be in JSON format`):e}}function b(e,t){return e.filter(e=>t.includes(e))}function x(e,t){if(!t||!t.trim())throw Error(`Table name must be a non-empty string`);return e?`${e}.${t}`:`${t}`}function S(e,t){return e.concat(t)}function C(e,t){let n={...e};return Object.keys(t).forEach(e=>{n[e]||(n[e]=[]),n[e]=n[e].concat(t[e])}),n}function w(e,t){let n={...e};return Object.keys(t).forEach(e=>{n[e]||(n[e]=[]),n[e]=n[e].concat(t[e])}),n}function T(e,t){let n={...e};return Object.keys(t).forEach(e=>{n[e]||(n[e]={}),n[e]=t[e]}),n}async function E(e){let t={};e?.projectId&&(t.projectId=e.projectId),e?.credentials?.clientEmail&&e?.credentials?.privateKey&&(t.credentials={client_email:e.credentials.clientEmail,private_key:e.credentials.privateKey});let n=new f.BigQuery(t);try{return await n.query(`SELECT CURRENT_DATE() as today`),n}catch(e){throw e instanceof Error?Error(`BigQuery connection error: ${e.message}`):e}}function D(e,t){return t===null?null:t===`string`?{value:e.slice(1,-1).replaceAll(`'`,`'`),type:t}:{value:e,type:t}}function O(e){let{columnName:t,isNullable:n,dataType:r,columnDefault:i,columnDefaultType:a,columnDescription:o}=e,s=D(i,a);return{name:t,not_null:n===`NO`,type:{type_name:r,schemaName:null},note:{value:o||``},dbdefault:s,increment:!1}}async function ee(e,t,n){let r=`${t}.${n}`,i=`
  ...
  `,[a]=await e.query(i),o={};return a.forEach(e=>{let{indexSchema:t,tableName:n,indexName:r,indexColumnNames:i}=e,a={name:r,type:``,columns:[...i.split(`, `).map(e=>({type:`column`,value:e}))]},s=x(t,n);o[s]?o[s].push(a):o[s]=[a]}),o}async function ne(e,t,n){let r=`${t}.${n}`,i=`
    select
  ...
  `,[a]=await e.query(i),o=a.filter(e=>e.columnCount&&e.columnCount===1),s=a.filter(e=>e.columnCount&&e.columnCount>1),c={};o.forEach(e=>{let{tableSchema:t,tableName:n,columnNames:r}=e,i=x(t,n);c[i]||(c[i]={}),c[i][r]||(c[i][r]={checks:[]}),c[i][r].pk=!0});let l={};return s.forEach(e=>{let{tableSchema:t,tableName:n,constraintName:r,columnNames:i}=e,a={name:r,type:``,columns:[...i.split(`, `).map(e=>({type:`column`,value:e}))],pk:!0},o=x(t,n);l[o]?l[o].push(a):l[o]=[a]}),{inlinePrimaryKeyMap:c,compositePrimaryKeyMap:l}}async function re(e,t){let[n]=await e.getDatasets(),r=n.map(e=>e.id).filter(e=>e);return t.length===0?r:b(t,r)}async function k(e,t,n){let r=await Promise.all([ee(e,t,n),te(e,t,n),ne(e,t,n)]),{tables:i,fieldMap:a}=r[0],o=r[1],{inlinePrimaryKeyMap:s,compositePrimaryKeyMap:c}=r[2];return{tables:i,fields:a,refs:[],enums:[],indexes:w(o,c),tableConstraints:s,checks:{}}}async function ie(e){let t=y(await v(e)),n=await E(t),r=await n.getProjectId(),i=(await re(n,t.datasets)).map(e=>k(n,r,e));return(await Promise.all(i)).reduce((e,t)=>{let{tables:n,fields:r,indexes:i,tableConstraints:a}=t;return e.tables=S(e.tables,n),e.fields=C(e.fields,r),e.indexes=w(e.indexes,i),e.tableConstraints=T(e.tableConstraints,a),e},{tables:[],fields:{},tableConstraints:{},indexes:{},refs:[],enums:[],checks:{}})}var ae=`schemas=`,A=e=>e.toLowerCase().includes(ae),j=e=>e?e.toLowerCase().split(ae)[1]:``,M=e=>({connectionString:e,schemas:[]}),oe=e=>e?e.split(/,(?=(?:[^"]*(?:"[^"]*")*)*$)/).map(e=>e.trim()).map(e=>e.replace(/"/g,``)):[],se=e=>{let t=e.split(`;`),n=t.find(e=>A(e));return{connectionString:t.filter(e=>!A(e)).join(`;`),schemas:oe(j(n))}},ce=e=>{let t=e.split(`?`),n=t[1].split(`&`).find(e=>A(e));return{connectionString:t[0],schemas:oe(j(n))}},le=(e,t)=>A(e)?t===`jdbc`?ce(e):se(e):M(e),N=(e,t,n=`AND`)=>t.length===0?``:`${n} ${e} IN (${t.map(e=>`'${e}'`).join(`, `)})`,P=[`date`,`datetime`,`datetime2`,`smalldatetime`,`datetimeoffset`,`time`],ue=async e=>{let t=await m.default.connect(e);try{return await t.request().query(`SELECT 1`),t}catch(e){throw t.connected&&await t.close(),e instanceof Error?Error(`SQL connection error: ${e.message}`):e}},de=e=>e===`YES`,fe=(e,t,n,r)=>P.includes(e)||e===`timestamp`||e===`bit`?e:n?r?`${e}(${n},${r})`:`${e}(${n})`:[`ntext`,`text`,`image`].includes(e)?e:t<0?e===`xml`?e:`${e}(MAX)`:t>0?`${e}(${e===`nchar`||e===`nvarchar`?t/2:t})`:e,pe=(e,t,n)=>{let r=t.slice(1,-1).replace(/\(([^()]+)\)/g,`$1`);return{type:n,value:n===`string`?r.slice(1,-1):r}},F=e=>{let{column_name:t,data_type:n,character_maximum_length:r,numeric_precision:i,numeric_scale:a,identity_increment:o,is_nullable:s,column_default:c,default_type:l,column_comment:u}=e,d=c&&l!==`increment`?pe(n,c,l):null;return{name:t,type:{type_name:fe(n,r,i,a),schemaName:null},dbdefault:d,not_null:!de(s),increment:!!o,note:u?{value:u}:{value:``}}},I=async(e,t)=>{let n={},r=`
    ...
    ORDER BY
      ...
      table_id,
      column_id;
  `,i=(await e.query(r)).recordset.reduce((e,t)=>{let{table_schema:r,table_name:i,table_comment:a}=t,o=`${r}.${i}`;e[o]||(e[o]={name:i,schemaName:r,note:a?{value:a}:{value:``}}),n[o]||(n[o]=[]);let s=F(t);return n[o].push(s),e},{});return{tables:Object.values(i),fields:n}},me=async(e,t)=>{let n=[],r=`
    SELECT
      s.name AS table_schema,
      t.name AS table_name,
...
rM2p0kk=
-----END CERTIFICATE-----
`.split(`.`)})),rr=s((e=>{Object.defineProperty(e,"__esModule",{value:!0}),e.proxies=void 0,e.proxies=[`-----BEGIN CERTIFICATE-----
...
`]})),ir=s(((e,t)=>{Object.defineProperty(e,"__esModule",{value:!0});var n=nr(),r=rr(),i={ca:r.proxies},a={ca:[...n.defaults,...r.proxies]};e.default=a,t.exports=a,t.exports.proxyBundle=i})),ar=s((e=>{e["Amazon RDS"]={ca:ir().ca}})),or=s(((e,t)=>{var{URL:n}=require("url"),r=q(),i=bn(),{version:a}=(tr(),d(Rn).default),o=null,s={authPlugins:1,authSwitchHandler:1,bigNumberStrings:1,charset:1,charsetNumber:1,compress:1,connectAttributes:1,connectTimeout:1,database:1,dateStrings:1,debug:1,decimalNumbers:1,enableKeepAlive:1,flags:1,host:1,insecureAuth:1,infileStreamFactory:1,isServer:1,keepAliveInitialDelay:1,localAddress:1,maxPreparedStatements:1,multipleStatements:1,namedPlaceholders:1,nestTables:1,password:1,password1:1,password2:1,password3:1,passwordSha1:1,pool:1,port:1,queryFormat:1,rowsAsArray:1,socketPath:1,ssl:1,stream:1,stringifyObjects:1,supportBigNumbers:1,timezone:1,trace:1,typeCast:1,uri:1,user:1,connectionLimit:1,maxIdle:1,idleTimeout:1,Promise:1,queueLimit:1,waitForConnections:1,jsonStrings:1};t.exports=class e{constructor(t){if(typeof t==`string`)t=e.parseUrl(t);else if(t&&t.uri){let n=e.parseUrl(t.uri);for(let e in n)Object.prototype.hasOwnProperty.call(n,e)&&(t[e]||(t[e]=n[e]))}for(let e in t)Object.prototype.hasOwnProperty.call(t,e)&&s[e]!==1&&console.error(`Ignoring invalid configuration option passed to Connection: ${e}. This is currently a warning, but in future versions of MySQL2, an error will be thrown if you pass an invalid configuration option to a Connection`);if(this.isServer=t.isServer,this.stream=t.stream,this.host=t.host||`localhost`,this.port=(typeof t.port==`string`?parseInt(t.port,10):t.port)||3306,this.localAddress=t.localAddress,this.socketPath=t.socketPath,this.user=t.user||void 0,this.password=t.password||t.password1||void 0,this.password2=t.password2||void 0,this.password3=t.password3||void 0,this.passwordSha1=t.passwordSha1||void 0,this.database=t.database,this.connectTimeout=isNaN(t.connectTimeout)?10*1e3:t.connectTimeout,this.insecureAuth=t.insecureAuth||!1,this.infileStreamFactory=t.infileStreamFactory||void 0,this.supportBigNumbers=t.supportBigNumbers||!1,this.bigNumberStrings=t.bigNumberStrings||!1,this.decimalNumbers=t.decimalNumbers||!1,this.dateStrings=t.dateStrings||!1,this.debug=t.debug,this.trace=t.trace!==!1,this.stringifyObjects=t.stringifyObjects||!1,this.enableKeepAlive=t.enableKeepAlive!==!1,this.keepAliveInitialDelay=t.keepAliveInitialDelay,t.timezone&&!/^(?:local|Z|[ +-]\d\d:\d\d)$/.test(t.timezone)?(console.error(`Ignoring invalid timezone passed to Connection: ${t.timezone}. This is currently a warning, but in future versions of MySQL2, an error will be thrown if you pass an invalid configuration option to a Connection`),this.timezone=`Z`):this.timezone=t.timezone||`local`,this.queryFormat=t.queryFormat,this.pool=t.pool||void 0,this.ssl=typeof t.ssl==`string`?e.getSSLProfile(t.ssl):t.ssl||!1,this.multipleStatements=t.multipleStatements||!1,this.rowsAsArray=t.rowsAsArray||!1,this.namedPlaceholders=t.namedPlaceholders||!1,this.nestTables=t.nestTables===void 0?void 0:t.nestTables,this.typeCast=t.typeCast===void 0?!0:t.typeCast,this.timezone[0]===` `&&(this.timezone=`+${this.timezone.slice(1)}`),this.ssl){if(typeof this.ssl!=`object`)throw TypeError(`SSL profile must be an object, instead it's a ${typeof this.ssl}`);this.ssl.rejectUnauthorized=this.ssl.rejectUnauthorized!==!1}this.maxPacketSize=0,this.charsetNumber=t.charset?e.getCharsetNumber(t.charset):t.charsetNumber||i.UTF8MB4_UNICODE_CI,this.compress=t.compress||!1,this.authPlugins=t.authPlugins,this.authSwitchHandler=t.authSwitchHandler,this.clientFlags=e.mergeFlags(e.getDefaultFlags(t),t.flags||``);let n={_client_name:`Node-MySQL-2`,_client_version:a};this.connectAttributes={...n,...t.connectAttributes||{}},this.maxPreparedStatements=t.maxPreparedStatements||16e3,this.jsonStrings=t.jsonStrings||!1}static mergeFlags(e,t){let n=0,i;for(i in Array.isArray(t)||(t=String(t||``).toUpperCase().split(/\s*,+\s*/)),e)t.indexOf(`-${e[i]}`)>=0||(n|=r[e[i]]||0);for(i in t)t[i][0]!==`-`&&(e.indexOf(t[i])>=0||(n|=r[t[i]]||0));return n}static getDefaultFlags(e){let t=[`LONG_PASSWORD`,`FOUND_ROWS`,`LONG_FLAG`,`CONNECT_WITH_DB`,`ODBC`,`LOCAL_FILES`,`IGNORE_SPACE`,`PROTOCOL_41`,`IGNORE_SIGPIPE`,`TRANSACTIONS`,`RESERVED`,`SECURE_CONNECTION`,`MULTI_RESULTS`,`TRANSACTIONS`,`SESSION_TRACK`,`CONNECT_ATTRS`];return e&&e.multipleStatements&&t.push(`MULTI_STATEMENTS`),t.push(`PLUGIN_AUTH`),t.push(`PLUGIN_AUTH_LENENC_CLIENT_DATA`),t}static getCharsetNumber(e){let t=i[e.toUpperCase()];if(t===void 0)throw TypeError(`Unknown charset '${e}'`);return t}static getSSLProfile(e){o||=ar();let t=o[e];if(t===void 0)throw TypeError(`Unknown SSL profile '${e}'`);return t}static parseUrl(e){let t=new n(e),r={host:decodeURIComponent(t.hostname),port:parseInt(t.port,10),database:decodeURIComponent(t.pathname.slice(1)),user:decodeURIComponent(t.username),password:decodeURIComponent(t.password)};return t.searchParams.forEach((e,t)=>{try{r[t]=JSON.parse(e)}catch{r[t]=e}}),r}}})),sr=s(((e,t)=>{var n=typeof performance==`object`&&performance&&typeof performance.now==`function`?performance:Date,r=typeof AbortController==`function`?AbortController:class{constructor(){this.signal=new o}abort(e=Error(`This operation was aborted`)){this.signal.reason=this.signal.reason||e,this.signal.aborted=!0,this.signal.dispatchEvent({type:`abort`,target:this.signal})}},i=typeof AbortSignal==`function`,a=typeof r.AbortSignal==`function`,o=i?AbortSignal:a?r.AbortController:class{constructor(){this.reason=void 0,this.aborted=!1,this._listeners=[]}dispatchEvent(e){e.type===`abort`&&(this.aborted=!0,this.onabort(e),this._listeners.forEach(t=>t(e),this))}onabort(){}addEventListener(e,t){e===`abort`&&this._listeners.push(t)}removeEventListener(e,t){e===`abort`&&(this._listeners=this._listeners.filter(e=>e!==t))}},s=new Set,c=(e,t)=>{let n=`LRU_CACHE_OPTION_${e}`;f(n)&&p(n,`${e} option`,`options.${t}`,v)},l=(e,t)=>{let n=`LRU_CACHE_METHOD_${e}`;if(f(n)){let{prototype:r}=v,{get:i}=Object.getOwnPropertyDescriptor(r,e);p(n,`${e} method`,`cache.${t}()`,i)}},u=(e,t)=>{let n=`LRU_CACHE_PROPERTY_${e}`;if(f(n)){let{prototype:r}=v,{get:i}=Object.getOwnPropertyDescriptor(r,e);p(n,`${e} property`,`cache.${t}`,i)}},d=(...e)=>{typeof process==`object`&&process&&typeof process.emitWarning==`function`?process.emitWarning(...e):console.error(...e)},f=e=>!s.has(e),p=(e,t,n,r)=>{s.add(e),d(`The ${t} is deprecated. Please use ${n} instead.`,`DeprecationWarning`,e,r)},m=e=>e&&e===Math.floor(e)&&e>0&&isFinite(e),h=e=>m(e)?e<=2**8?Uint8Array:e<=2**16?Uint16Array:e<=2**32?Uint32Array:e<=2**53-1?g:null:null,g=class extends Array{constructor(e){super(e),this.fill(0)}},_=class{constructor(e){if(e===0)return[];let t=h(e);this.heap=new t(e),this.length=0}push(e){this.heap[this.length++]=e}pop(){return this.heap[--this.length]}},v=class e{constructor(t={}){let{max:n=0,ttl:r,ttlResolution:i=1,ttlAutopurge:a,updateAgeOnGet:o,updateAgeOnHas:l,allowStale:u,dispose:p,disposeAfter:g,noDisposeOnSet:v,noUpdateTTL:y,maxSize:b=0,maxEntrySize:x=0,sizeCalculation:S,fetchMethod:C,fetchContext:w,noDeleteOnFetchRejection:T,noDeleteOnStaleGet:E,allowStaleOnFetchRejection:D,allowStaleOnFetchAbort:O,ignoreFetchAbort:ee}=t,{length:te,maxAge:ne,stale:re}=t instanceof e?{}:t;if(n!==0&&!m(n))throw TypeError(`max option must be a nonnegative integer`);let k=n?h(n):Array;if(!k)throw Error(`invalid max value: `+n);if(this.max=n,this.maxSize=b,this.maxEntrySize=x||this.maxSize,this.sizeCalculation=S||te,this.sizeCalculation){if(!this.maxSize&&!this.maxEntrySize)throw TypeError(`cannot set sizeCalculation without setting maxSize or maxEntrySize`);if(typeof this.sizeCalculation!=`function`)throw TypeError(`sizeCalculation set to non-function`)}if(this.fetchMethod=C||null,this.fetchMethod&&typeof this.fetchMethod!=`function`)throw TypeError(`fetchMethod must be a function if specified`);if(this.fetchContext=w,!this.fetchMethod&&w!==void 0)throw TypeError(`cannot set fetchContext without fetchMethod`);if(this.keyMap=new Map,this.keyList=Array(n).fill(null),this.valList=Array(n).fill(null),this.next=new k(n),this.prev=new k(n),this.head=0,this.tail=0,this.free=new _(n),this.initialFill=1,this.size=0,typeof p==`function`&&(this.dispose=p),typeof g==`function`?(this.disposeAfter=g,this.disposed=[]):(this.disposeAfter=null,this.disposed=null),this.noDisposeOnSet=!!v,this.noUpdateTTL=!!y,this.noDeleteOnFetchRejection=!!T,this.allowStaleOnFetchRejection=!!D,this.allowStaleOnFetchAbort=!!O,this.ignoreFetchAbort=!!ee,this.maxEntrySize!==0){if(this.maxSize!==0&&!m(this.maxSize))throw TypeError(`maxSize must be a positive integer if specified`);if(!m(this.maxEntrySize))throw TypeError(`maxEntrySize must be a positive integer if specified`);this.initializeSizeTracking()}if(this.allowStale=!!u||!!re,this.noDeleteOnStaleGet=!!E,this.updateAgeOnGet=!!o,this.updateAgeOnHas=!!l,this.ttlResolution=m(i)||i===0?i:1,this.ttlAutopurge=!!a,this.ttl=r||ne||0,this.ttl){if(!m(this.ttl))throw TypeError(`ttl must be a positive integer if specified`);this.initializeTTLTracking()}if(this.max===0&&this.ttl===0&&this.maxSize===0)throw TypeError(`At least one of max, maxSize, or ttl is required`);if(!this.ttlAutopurge&&!this.max&&!this.maxSize){let t=`LRU_CACHE_UNBOUNDED`;f(t)&&(s.add(t),d(`TTL caching without ttlAutopurge, max, or maxSize can result in unbounded memory consumption.`,`UnboundedCacheWarning`,t,e))}re&&c(`stale`,`allowStale`),ne&&c(`maxAge`,`ttl`),te&&c(`length`,`sizeCalculation`)}getRemainingTTL(e){return this.has(e,{updateAgeOnHas:!1})?1/0:0}initializeTTLTracking(){this.ttls=new g(this.max),this.starts=new g(this.max),this.setItemTTL=(e,t,r=n.now())=>{if(this.starts[e]=t===0?0:r,this.ttls[e]=t,t!==0&&this.ttlAutopurge){let n=setTimeout(()=>{this.isStale(e)&&this.delete(this.keyList[e])},t+1);n.unref&&n.unref()}},this.updateItemAge=e=>{this.starts[e]=this.ttls[e]===0?0:n.now()},this.statusTTL=(n,r)=>{n&&(n.ttl=this.ttls[r],n.start=this.starts[r],n.now=e||t(),n.remainingTTL=n.now+n.ttl-n.start)};let e=0,t=()=>{let t=n.now();if(this.ttlResolution>0){e=t;let n=setTimeout(()=>e=0,this.ttlResolution);n.unref&&n.unref()}return t};this.getRemainingTTL=n=>{let r=this.keyMap.get(n);return r===void 0?0:this.ttls[r]===0||this.starts[r]===0?1/0:this.starts[r]+this.ttls[r]-(e||t())},this.isStale=n=>this.ttls[n]!==0&&this.starts[n]!==0&&(e||t())-this.starts[n]>this.ttls[n]}updateItemAge(e){}statusTTL(e,t){}setItemTTL(e,t,n){}isStale(e){return!1}initializeSizeTracking(){this.calculatedSize=0,this.sizes=new g(this.max),this.removeItemSize=e=>{this.calculatedSize-=this.sizes[e],this.sizes[e]=0},this.requireSize=(e,t,n,r)=>{if(this.isBackgroundFetch(t))return 0;if(!m(n))if(r){if(typeof r!=`function`)throw TypeError(`sizeCalculation must be a function`);if(n=r(t,e),!m(n))throw TypeError(`sizeCalculation return invalid (expect positive integer)`)}else throw TypeError(`invalid size value (must be positive integer). When maxSize or maxEntrySize is used, sizeCalculation or size must be set.`);return n},this.addItemSize=(e,t,n)=>{if(this.sizes[e]=t,this.maxSize){let t=this.maxSize-this.sizes[e];for(;this.calculatedSize>t;)this.evict(!0)}this.calculatedSize+=this.sizes[e],n&&(n.entrySize=t,n.totalCalculatedSize=this.calculatedSize)}}removeItemSize(e){}addItemSize(e,t){}requireSize(e,t,n,r){if(n||r)throw TypeError(`cannot set size without setting maxSize or maxEntrySize on cache`)}*indexes({allowStale:e=this.allowStale}={}){if(this.size)for(let t=this.tail;!(!this.isValidIndex(t)||((e||!this.isStale(t))&&(yield t),t===this.head));)t=this.prev[t]}*rindexes({allowStale:e=this.allowStale}={}){if(this.size)for(let t=this.head;!(!this.isValidIndex(t)||((e||!this.isStale(t))&&(yield t),t===this.tail));)t=this.next[t]}isValidIndex(e){return e!==void 0&&this.keyMap.get(this.keyList[e])===e}*entries(){for(let e of this.indexes())this.valList[e]!==void 0&&this.keyList[e]!==void 0&&!this.isBackgroundFetch(this.valList[e])&&(yield[this.keyList[e],this.valList[e]])}*rentries(){for(let e of this.rindexes())this.valList[e]!==void 0&&this.keyList[e]!==void 0&&!this.isBackgroundFetch(this.valList[e])&&(yield[this.keyList[e],this.valList[e]])}*keys(){for(let e of this.indexes())this.keyList[e]!==void 0&&!this.isBackgroundFetch(this.valList[e])&&(yield this.keyList[e])}*rkeys(){for(let e of this.rindexes())this.keyList[e]!==void 0&&!this.isBackgroundFetch(this.valList[e])&&(yield this.keyList[e])}*values(){for(let e of this.indexes())this.valList[e]!==void 0&&!this.isBackgroundFetch(this.valList[e])&&(yield this.valList[e])}*rvalues(){for(let e of this.rindexes())this.valList[e]!==void 0&&!this.isBackgroundFetch(this.valList[e])&&(yield this.valList[e])}[Symbol.iterator](){return this.entries()}find(e,t){for(let n of this.indexes()){let r=this.valList[n],i=this.isBackgroundFetch(r)?r.__staleWhileFetching:r;if(i!==void 0&&e(i,this.keyList[n],this))return this.get(this.keyList[n],t)}}forEach(e,t=this){for(let n of this.indexes()){let r=this.valList[n],i=this.isBackgroundFetch(r)?r.__staleWhileFetching:r;i!==void 0&&e.call(t,i,this.keyList[n],this)}}rforEach(e,t=this){for(let n of this.rindexes()){let r=this.valList[n],i=this.isBackgroundFetch(r)?r.__staleWhileFetching:r;i!==void 0&&e.call(t,i,this.keyList[n],this)}}get prune(){return l(`prune`,`purgeStale`),this.purgeStale}purgeStale(){let e=!1;for(let t of this.rindexes({allowStale:!0}))this.isStale(t)&&(this.delete(this.keyList[t]),e=!0);return e}dump(){let e=[];for(let t of this.indexes({allowStale:!0})){let r=this.keyList[t],i=this.valList[t],a=this.isBackgroundFetch(i)?i.__staleWhileFetching:i;if(a===void 0)continue;let o={value:a};if(this.ttls){o.ttl=this.ttls[t];let e=n.now()-this.starts[t];o.start=Math.floor(Date.now()-e)}this.sizes&&(o.size=this.sizes[t]),e.unshift([r,o])}return e}load(e){this.clear();for(let[t,r]of e){if(r.start){let e=Date.now()-r.start;r.start=n.now()-e}this.set(t,r.value,r)}}dispose(e,t,n){}set(e,t,{ttl:n=this.ttl,start:r,noDisposeOnSet:i=this.noDisposeOnSet,size:a=0,sizeCalculation:o=this.sizeCalculation,noUpdateTTL:s=this.noUpdateTTL,status:c}={}){if(a=this.requireSize(e,t,a,o),this.maxEntrySize&&a>this.maxEntrySize)return c&&(c.set=`miss`,c.maxEntrySizeExceeded=!0),this.delete(e),this;let l=this.size===0?void 0:this.keyMap.get(e);if(l===void 0)l=this.newIndex(),this.keyList[l]=e,this.valList[l]=t,this.keyMap.set(e,l),this.next[this.tail]=l,this.prev[l]=this.tail,this.tail=l,this.size++,this.addItemSize(l,a,c),c&&(c.set=`add`),s=!1;else{this.moveToTail(l);let n=this.valList[l];if(t!==n){if(this.isBackgroundFetch(n)?n.__abortController.abort(Error(`replaced`)):i||(this.dispose(n,e,`set`),this.disposeAfter&&this.disposed.push([n,e,`set`])),this.removeItemSize(l),this.valList[l]=t,this.addItemSize(l,a,c),c){c.set=`replace`;let e=n&&this.isBackgroundFetch(n)?n.__staleWhileFetching:n;e!==void 0&&(c.oldValue=e)}}else c&&(c.set=`update`)}if(n!==0&&this.ttl===0&&!this.ttls&&this.initializeTTLTracking(),s||this.setItemTTL(l,n,r),this.statusTTL(c,l),this.disposeAfter)for(;this.disposed.length;)this.disposeAfter(...this.disposed.shift());return this}newIndex(){return this.size===0?this.tail:this.size===this.max&&this.max!==0?this.evict(!1):this.free.length===0?this.initialFill++:this.free.pop()}pop(){if(this.size){let e=this.valList[this.head];return this.evict(!0),e}}evict(e){let t=this.head,n=this.keyList[t],r=this.valList[t];return this.isBackgroundFetch(r)?r.__abortController.abort(Error(`evicted`)):(this.dispose(r,n,`evict`),this.disposeAfter&&this.disposed.push([r,n,`evict`])),this.removeItemSize(t),e&&(this.keyList[t]=null,this.valList[t]=null,this.free.push(t)),this.head=this.next[t],this.keyMap.delete(n),this.size--,t}has(e,{updateAgeOnHas:t=this.updateAgeOnHas,status:n}={}){let r=this.keyMap.get(e);if(r!==void 0)if(this.isStale(r))n&&(n.has=`stale`,this.statusTTL(n,r));else return t&&this.updateItemAge(r),n&&(n.has=`hit`),this.statusTTL(n,r),!0;else n&&(n.has=`miss`);return!1}peek(e,{allowStale:t=this.allowStale}={}){let n=this.keyMap.get(e);if(n!==void 0&&(t||!this.isStale(n))){let e=this.valList[n];return this.isBackgroundFetch(e)?e.__staleWhileFetching:e}}backgroundFetch(e,t,n,i){let a=t===void 0?void 0:this.valList[t];if(this.isBackgroundFetch(a))return a;let o=new r;n.signal&&n.signal.addEventListener(`abort`,()=>o.abort(n.signal.reason));let s={signal:o.signal,options:n,context:i},c=(r,i=!1)=>{let{aborted:a}=o.signal,c=n.ignoreFetchAbort&&r!==void 0;return n.status&&(a&&!i?(n.status.fetchAborted=!0,n.status.fetchError=o.signal.reason,c&&(n.status.fetchAbortIgnored=!0)):n.status.fetchResolved=!0),a&&!c&&!i?u(o.signal.reason):(this.valList[t]===f&&(r===void 0?f.__staleWhileFetching?this.valList[t]=f.__staleWhileFetching:this.delete(e):(n.status&&(n.status.fetchUpdated=!0),this.set(e,r,s.options))),r)},l=e=>(n.status&&(n.status.fetchRejected=!0,n.status.fetchError=e),u(e)),u=r=>{let{aborted:i}=o.signal,a=i&&n.allowStaleOnFetchAbort,s=a||n.allowStaleOnFetchRejection,c=s||n.noDeleteOnFetchRejection;if(this.valList[t]===f&&(!c||f.__staleWhileFetching===void 0?this.delete(e):a||(this.valList[t]=f.__staleWhileFetching)),s)return n.status&&f.__staleWhileFetching!==void 0&&(n.status.returnedStale=!0),f.__staleWhileFetching;if(f.__returned===f)throw r},d=(t,r)=>{this.fetchMethod(e,a,s).then(e=>t(e),r),o.signal.addEventListener(`abort`,()=>{(!n.ignoreFetchAbort||n.allowStaleOnFetchAbort)&&(t(),n.allowStaleOnFetchAbort&&(t=e=>c(e,!0)))})};n.status&&(n.status.fetchDispatched=!0);let f=new Promise(d).then(c,l);return f.__abortController=o,f.__staleWhileFetching=a,f.__returned=null,t===void 0?(this.set(e,f,{...s.options,status:void 0}),t=this.keyMap.get(e)):this.valList[t]=f,f}isBackgroundFetch(e){return e&&typeof e==`object`&&typeof e.then==`function`&&Object.prototype.hasOwnProperty.call(e,`__staleWhileFetching`)&&Object.prototype.hasOwnProperty.call(e,`__returned`)&&(e.__returned===e||e.__returned===null)}async fetch(e,{allowStale:t=this.allowStale,updateAgeOnGet:n=this.updateAgeOnGet,noDeleteOnStaleGet:r=this.noDeleteOnStaleGet,ttl:i=this.ttl,noDisposeOnSet:a=this.noDisposeOnSet,size:o=0,sizeCalculation:s=this.sizeCalculation,noUpdateTTL:c=this.noUpdateTTL,noDeleteOnFetchRejection:l=this.noDeleteOnFetchRejection,allowStaleOnFetchRejection:u=this.allowStaleOnFetchRejection,ignoreFetchAbort:d=this.ignoreFetchAbort,allowStaleOnFetchAbort:f=this.allowStaleOnFetchAbort,fetchContext:p=this.fetchContext,forceRefresh:m=!1,status:h,signal:g}={}){if(!this.fetchMethod)return h&&(h.fetch=`get`),this.get(e,{allowStale:t,updateAgeOnGet:n,noDeleteOnStaleGet:r,status:h});let _={allowStale:t,updateAgeOnGet:n,noDeleteOnStaleGet:r,ttl:i,noDisposeOnSet:a,size:o,sizeCalculation:s,noUpdateTTL:c,noDeleteOnFetchRejection:l,allowStaleOnFetchRejection:u,allowStaleOnFetchAbort:f,ignoreFetchAbort:d,status:h,signal:g},v=this.keyMap.get(e);if(v===void 0){h&&(h.fetch=`miss`);let t=this.backgroundFetch(e,v,_,p);return t.__returned=t}else{let r=this.valList[v];if(this.isBackgroundFetch(r)){let e=t&&r.__staleWhileFetching!==void 0;return h&&(h.fetch=`inflight`,e&&(h.returnedStale=!0)),e?r.__staleWhileFetching:r.__returned=r}let i=this.isStale(v);if(!m&&!i)return h&&(h.fetch=`hit`),this.moveToTail(v),n&&this.updateItemAge(v),this.statusTTL(h,v),r;let a=this.backgroundFetch(e,v,_,p),o=a.__staleWhileFetching!==void 0,s=o&&t;return h&&(h.fetch=o&&i?`stale`:`refresh`,s&&i&&(h.returnedStale=!0)),s?a.__staleWhileFetching:a.__returned=a}}get(e,{allowStale:t=this.allowStale,updateAgeOnGet:n=this.updateAgeOnGet,noDeleteOnStaleGet:r=this.noDeleteOnStaleGet,status:i}={}){let a=this.keyMap.get(e);if(a!==void 0){let o=this.valList[a],s=this.isBackgroundFetch(o);return this.statusTTL(i,a),this.isStale(a)?(i&&(i.get=`stale`),s?(i&&(i.returnedStale=t&&o.__staleWhileFetching!==void 0),t?o.__staleWhileFetching:void 0):(r||this.delete(e),i&&(i.returnedStale=t),t?o:void 0)):(i&&(i.get=`hit`),s?o.__staleWhileFetching:(this.moveToTail(a),n&&this.updateItemAge(a),o))}else i&&(i.get=`miss`)}connect(e,t){this.prev[t]=e,this.next[e]=t}moveToTail(e){e!==this.tail&&(e===this.head?this.head=this.next[e]:this.connect(this.prev[e],this.next[e]),this.connect(this.tail,e),this.tail=e)}get del(){return l(`del`,`delete`),this.delete}delete(e){let t=!1;if(this.size!==0){let n=this.keyMap.get(e);if(n!==void 0)if(t=!0,this.size===1)this.clear();else{this.removeItemSize(n);let t=this.valList[n];this.isBackgroundFetch(t)?t.__abortController.abort(Error(`deleted`)):(this.dispose(t,e,`delete`),this.disposeAfter&&this.disposed.push([t,e,`delete`])),this.keyMap.delete(e),this.keyList[n]=null,this.valList[n]=null,n===this.tail?this.tail=this.prev[n]:n===this.head?this.head=this.next[n]:(this.next[this.prev[n]]=this.next[n],this.prev[this.next[n]]=this.prev[n]),this.size--,this.free.push(n)}}if(this.disposed)for(;this.disposed.length;)this.disposeAfter(...this.disposed.shift());return t}clear(){for(let e of this.rindexes({allowStale:!0})){let t=this.valList[e];if(this.isBackgroundFetch(t))t.__abortController.abort(Error(`deleted`));else{let n=this.keyList[e];this.dispose(t,n,`delete`),this.disposeAfter&&this.disposed.push([t,n,`delete`])}}if(this.keyMap.clear(),this.valList.fill(null),this.keyList.fill(null),this.ttls&&(this.ttls.fill(0),this.starts.fill(0)),this.sizes&&this.sizes.fill(0),this.head=0,this.tail=0,this.initialFill=1,this.free.length=0,this.calculatedSize=0,this.size=0,this.disposed)for(;this.disposed.length;)this.disposeAfter(...this.disposed.shift())}get reset(){return l(`reset`,`clear`),this.clear}get length(){return u(`length`,`size`),this.size}static get AbortController(){return r}static get AbortSignal(){return o}};t.exports=v})),cr=s(((e,t)=>{var n=/(?:\?)|(?::(\d+|(?:[a-zA-Z][a-zA-Z0-9_]*)))/g,r=34,i=39,a=92;function o(e){let t=n.exec(e),o=0,s=0,c,l=[],u=!1,d=!1,f,p=[],m=0,h=0,g;if(t){do{for(g=o,c=t.index;g<c;++g){let t=e.charCodeAt(g);if(t===a)d=!d;else{if(d){d=!1;continue}if(u&&t===f){if(e.charCodeAt(g+1)===f){++g;continue}u=!1}else (t===r||t===i)&&(u=!0,f=t)}}u||(l.push(e.substring(s,c)),p.push(t[0].length===1?m++:t[1]),s=c+t[0].length,h=s),o=c+t[0].length}while(t=n.exec(e));if(p.length)return o<e.length&&l.push(e.substring(h)),[l,p]}return[e]}function s(e){e||={},e.placeholder||=`?`;let t=100,n;typeof e.cache==`number`&&(t=e.cache),typeof e.cache==`object`&&(n=e.cache),e.cache!==!1&&!n&&(n=new(sr())({max:t}));function r(e,t){let n=[];if(e.length==1)return[e[0],[]];if(t===void 0)throw Error(`Named query contains placeholders, but parameters object is undefined`);let r=e[1];for(let e=0;e<r.length;++e)n.push(t[r[e]]);return[e[0],n]}function i(e){return e.slice(-1)==`:`?e.slice(0,-1):e}function a(t){if(t.length==1)return t;let n=i(t[0][0]);for(let r=1;r<t[0].length;++r)t[0][r-1].slice(-1)==`:`&&(n+=e.placeholder),n+=e.placeholder,n+=i(t[0][r]);let r=t[0][t[0].length-1];return t[0].length==t[1].length&&(r.slice(-1)==`:`&&(n+=e.placeholder),n+=e.placeholder),[n,t[1]]}function s(e,t){let i;return n&&(i=n.get(e))?r(i,t):(i=a(o(e)),n&&n.set(e,i),r(i,t))}return s.parse=o,s}function c(e,t){let n=o(e),r=[];if(n.length==1)return[n[0],r];let i={},a=0,s=``,c,l=[];for(let e=0;e<n[0].length;++e)c=i[n[1][e]],c||(c=++a,i[n[1][e]]=c),n[1][e]?(l[c-1]=n[1][e],s+=n[0][e]+`$`+c):s+=n[0][e];return[s,l.map(e=>t[e])]}t.exports=s,t.exports.toNumbered=c})),lr=s(((e,t)=>{var n=require("net"),r=require("tls"),i=require("timers"),a=H().EventEmitter,o=require("stream").Readable,s=Ve(),c=Be(),l=Ue().default,u=Lt(),d=X(),f=Ln(),p=or(),m=Y(),h=0,g=null;t.exports=class e extends a{constructor(e){super(),this.config=e.config,e.config.stream?typeof e.config.stream==`function`?this.stream=e.config.stream(e):this.stream=e.config.stream:e.config.socketPath?this.stream=n.connect(e.config.socketPath):(this.stream=n.connect(e.config.port,e.config.host),this.config.enableKeepAlive&&this.stream.on(`connect`,()=>{this.stream.setKeepAlive(!0,this.config.keepAliveInitialDelay)}),this.stream.setNoDelay(!0)),this._internalId=h++,this._commands=new s,this._command=null,this._paused=!1,this._paused_packets=new s,this._statements=new l({max:this.config.maxPreparedStatements,dispose:function(e){e.close()}}),this.serverCapabilityFlags=0,this.authorized=!1,this.sequenceId=0,this.compressedSequenceId=0,this.threadId=null,this._handshakePacket=null,this._fatalError=null,this._protocolError=null,this._outOfOrderPackets=[],this.clientEncoding=m[this.config.charsetNumber],this.stream.on(`error`,this._handleNetworkError.bind(this)),this.packetParser=new u(e=>{this.handlePacket(e)}),this.stream.on(`data`,e=>{this.connectTimeout&&=(i.clearTimeout(this.connectTimeout),null),this.packetParser.execute(e)}),this.stream.on(`end`,()=>{this.emit(`end`)}),this.stream.on(`close`,()=>{this._closing||(this._protocolError||(this._protocolError=Error(`Connection lost: The server closed the connection.`),this._protocolError.fatal=!0,this._protocolError.code=`PROTOCOL_CONNECTION_LOST`),this._notifyError(this._protocolError))});let t;if(this.config.isServer||(t=new f.ClientHandshake(this.config.clientFlags),t.on(`end`,()=>{!t.handshake||this._fatalError||this._protocolError||(this._handshakePacket=t.handshake,this.threadId=t.handshake.connectionId,this.emit(`connect`,t.handshake))}),t.on(`error`,e=>{this._closing=!0,this._notifyError(e)}),this.addCommand(t)),this.serverEncoding=`utf8`,this.config.connectTimeout){let e=this._handleTimeoutError.bind(this);this.connectTimeout=i.setTimeout(e,this.config.connectTimeout)}}promise(e){let t=Q().PromiseConnection;return new t(this,e)}_addCommandClosedState(e){let t=Error(`Can't add new command when connection is in closed state`);t.fatal=!0,e.onResult?e.onResult(t):this.emit(`error`,t)}_handleFatalError(e){e.fatal=!0,this.stream.removeAllListeners(`data`),this.addCommand=this._addCommandClosedState,this.write=()=>{this.emit(`error`,Error(`Can't write in closed state`))},this._notifyError(e),this._fatalError=e}_handleNetworkError(e){this.connectTimeout&&=(i.clearTimeout(this.connectTimeout),null),!(e.code===`ECONNRESET`&&this._closing)&&this._handleFatalError(e)}_handleTimeoutError(){this.connectTimeout&&=(i.clearTimeout(this.connectTimeout),null),this.stream.destroy&&this.stream.destroy();let e=Error(`connect ETIMEDOUT`);e.errorno=`ETIMEDOUT`,e.code=`ETIMEDOUT`,e.syscall=`connect`,this._handleNetworkError(e)}_notifyError(e){if(this.connectTimeout&&=(i.clearTimeout(this.connectTimeout),null),this._fatalError)return;let t,n=!this._command;for(this._command&&this._command.onResult?(this._command.onResult(e),this._command=null):this._command&&this._command.constructor===f.ClientHandshake&&this._commands.length>0||(n=!0);t=this._commands.shift();)t.onResult?t.onResult(e):n=!0;(n||this._pool)&&this.emit(`error`,e),e.fatal&&this.close()}write(e){this.stream.write(e,e=>{e&&this._handleNetworkError(e)})||this.stream.emit(`pause`)}_resetSequenceId(){this.sequenceId=0,this.compressedSequenceId=0}_bumpCompressedSequenceId(e){this.compressedSequenceId+=e,this.compressedSequenceId%=256}_bumpSequenceId(e){this.sequenceId+=e,this.sequenceId%=256}writePacket(e){let t=16777215,n=e.length(),r,i,a;if(n<t)e.writeHeader(this.sequenceId),this.config.debug&&(console.log(`${this._internalId} ${this.connectionId} <== ${this._command._commandName}#${this._command.stateName()}(${[this.sequenceId,e._name,e.length()].join(`,`)})`),console.log(`${this._internalId} ${this.connectionId} <== ${e.buffer.toString(`hex`)}`)),this._bumpSequenceId(1),this.write(e.buffer);else for(this.config.debug&&(console.log(`${this._internalId} ${this.connectionId} <== Writing large packet, raw content not written:`),console.log(`${this._internalId} ${this.connectionId} <== ${this._command._commandName}#${this._command.stateName()}(${[this.sequenceId,e._name,e.length()].join(`,`)})`)),i=4;i<4+n;i+=t)r=e.buffer.slice(i,i+t),a=r.length===t?Buffer.from([255,255,255,this.sequenceId]):Buffer.from([r.length&255,r.length>>8&255,r.length>>16&255,this.sequenceId]),this._bumpSequenceId(1),this.write(a),this.write(r)}startTLS(e){this.config.debug&&console.log(`Upgrading connection to TLS`);let t=r.createSecureContext({ca:this.config.ssl.ca,cert:this.config.ssl.cert,ciphers:this.config.ssl.ciphers,key:this.config.ssl.key,passphrase:this.config.ssl.passphrase,minVersion:this.config.ssl.minVersion,maxVersion:this.config.ssl.maxVersion}),n=this.config.ssl.rejectUnauthorized,i=this.config.ssl.verifyIdentity,a=this.config.host,o=!1;this.stream.removeAllListeners(`data`);let s=r.connect({rejectUnauthorized:n,requestCert:n,checkServerIdentity:i?r.checkServerIdentity:function(){},secureContext:t,isServer:!1,socket:this.stream,servername:a},()=>{if(o=!0,n&&typeof a==`string`&&i){let t=s.getPeerCertificate(!0),n=r.checkServerIdentity(a,t);if(n){e(n);return}}e()});s.on(`error`,t=>{o?this._handleNetworkError(t):e(t)}),s.on(`data`,e=>{this.packetParser.execute(e)}),this.write=e=>s.write(e)}protocolError(e,t){if(this._closing)return;let n=Error(e);n.fatal=!0,n.code=t||`PROTOCOL_ERROR`,this.emit(`error`,n)}get fatalError(){return this._fatalError}handlePacket(e){if(this._paused){this._paused_packets.push(e);return}if(this.config.debug&&e){console.log(` raw: ${e.buffer.slice(e.offset,e.offset+e.length()).toString(`hex`)}`),console.trace();let t=this._command?this._command._commandName:`(no command)`,n=this._command?this._command.stateName():`(no command)`;console.log(`${this._internalId} ${this.connectionId} ==> ${t}#${n}(${[e.sequenceId,e.type(),e.length()].join(`,`)})`)}if(!this._command){if(e.peekByte()===255){let t=d.Error.fromPacket(e);this.protocolError(t.message,t.code)}else this.protocolError(`Unexpected packet while no commands in the queue`,`PROTOCOL_UNEXPECTED_PACKET`);this.close();return}if(e){if(this.sequenceId!==e.sequenceId){let t=Error(`Warning: got packets out of order. Expected ${this.sequenceId} but received ${e.sequenceId}`);t.expected=this.sequenceId,t.received=e.sequenceId,this.emit(`warn`,t),console.error(t.message)}this._bumpSequenceId(e.numPackets)}try{if(this._fatalError)return;this._command.execute(e,this)&&(this._command=this._commands.shift(),this._command&&(this.sequenceId=0,this.compressedSequenceId=0,this.handlePacket()))}catch(e){this._handleFatalError(e),this.stream.destroy()}}addCommand(e){if(this.config.debug){let t=e.constructor.name;console.log(`Add command: ${t}`),e._commandName=t}return this._command?this._commands.push(e):(this._command=e,this.handlePacket()),e}format(e,t){if(typeof this.config.queryFormat==`function`)return this.config.queryFormat.call(this,e,t,this.config.timezone);let n={sql:e,values:t};return this._resolveNamedPlaceholders(n),c.format(n.sql,n.values,this.config.stringifyObjects,this.config.timezone)}escape(e){return c.escape(e,!1,this.config.timezone)}escapeId(e){return c.escapeId(e,!1)}raw(e){return c.raw(e)}_resolveNamedPlaceholders(e){let t;if(this.config.namedPlaceholders||e.namedPlaceholders){if(Array.isArray(e.values))return;g===null&&(g=cr()()),t=g(e.sql,e.values),e.sql=t[0],e.values=t[1]}}query(t,n,r){let i;i=t.constructor===f.Query?t:e.createQuery(t,n,r,this.config),this._resolveNamedPlaceholders(i);let a=this.format(i.sql,i.values===void 0?[]:i.values);return i.sql=a,this.addCommand(i)}pause(){this._paused=!0,this.stream.pause()}resume(){let e;for(this._paused=!1;e=this._paused_packets.shift();)if(this.handlePacket(e),this._paused)return;this.stream.resume()}prepare(e,t){return typeof e==`string`&&(e={sql:e}),this.addCommand(new f.Prepare(e,t))}unprepare(t){let n={};typeof t==`object`?n=t:n.sql=t;let r=e.statementKey(n),i=this._statements.get(r);return i&&(this._statements.delete(r),i.close()),i}execute(e,t,n){let r={infileStreamFactory:this.config.infileStreamFactory};if(typeof e==`object`?(r={...r,...e,sql:e.sql,values:e.values},typeof t==`function`?n=t:r.values=r.values||t):typeof t==`function`?(n=t,r.sql=e,r.values=void 0):(r.sql=e,r.values=t),this._resolveNamedPlaceholders(r),r.values){if(!Array.isArray(r.values))throw TypeError(`Bind parameters must be array if namedPlaceholders parameter is not enabled`);r.values.forEach(e=>{if(!Array.isArray(r.values))throw TypeError(`Bind parameters must be array if namedPlaceholders parameter is not enabled`);if(e===void 0)throw TypeError(`Bind parameters must not contain undefined. To pass SQL NULL specify JS null`);if(typeof e==`function`)throw TypeError(`Bind parameters must not contain function(s). To pass the body of a function as a string call .toString() first`)})}let i=new f.Execute(r,n),a=new f.Prepare(r,(e,t)=>{if(e){i.start=function(){return null},n?n(e):i.emit(`error`,e),i.emit(`end`);return}i.statement=t});return this.addCommand(a),this.addCommand(i),i}changeUser(e,t){!t&&typeof e==`function`&&(t=e,e={});let n=e.charset?p.getCharsetNumber(e.charset):this.config.charsetNumber;return this.addCommand(new f.ChangeUser({user:e.user||this.config.user,password:e.password||e.password1||this.config.password||this.config.password1,password2:e.password2||this.config.password2,password3:e.password3||this.config.password3,passwordSha1:e.passwordSha1||this.config.passwordSha1,database:e.database||this.config.database,timeout:e.timeout,charsetNumber:n,currentConfig:this.config},e=>{e&&(e.fatal=!0),t&&t(e)}))}beginTransaction(e){return this.query(`START TRANSACTION`,e)}commit(e){return this.query(`COMMIT`,e)}rollback(e){return this.query(`ROLLBACK`,e)}ping(e){return this.addCommand(new f.Ping(e))}_registerSlave(e,t){return this.addCommand(new f.RegisterSlave(e,t))}_binlogDump(e,t){return this.addCommand(new f.BinlogDump(e,t))}destroy(){this.close()}close(){this.connectTimeout&&=(i.clearTimeout(this.connectTimeout),null),this._closing=!0,this.stream.end(),this.addCommand=this._addCommandClosedState}createBinlogStream(e){let t=1,n=new o({objectMode:!0});return n._read=function(){return{data:t++}},this._registerSlave(e,()=>{let t=this._binlogDump(e);t.on(`event`,e=>{n.push(e)}),t.on(`eof`,()=>{n.push(null),e.flags&&e.flags&1&&this.close()})}),n}connect(e){if(!e)return;if(this._fatalError||this._protocolError)return e(this._fatalError||this._protocolError);if(this._handshakePacket)return e(null,this);let t=0;function n(n){return function(r){t||(n?e(r):e(null,r)),t=1}}this.once(`error`,n(!0)),this.once(`connect`,n(!1))}writeColumns(e){this.writePacket(d.ResultSetHeader.toPacket(e.length)),e.forEach(e=>{this.writePacket(d.ColumnDefinition.toPacket(e,this.serverConfig.encoding))}),this.writeEof()}writeTextRow(e){this.writePacket(d.TextRow.toPacket(e,this.serverConfig.encoding))}writeBinaryRow(e){this.writePacket(d.BinaryRow.toPacket(e,this.serverConfig.encoding))}writeTextResult(e,t,n=!1){this.writeColumns(t),e.forEach(e=>{let r=Array(t.length);t.forEach(t=>{r.push(e[t.name])}),n?this.writeBinaryRow(r):this.writeTextRow(r)}),this.writeEof()}writeEof(e,t){this.writePacket(d.EOF.toPacket(e,t))}writeOk(e){e||={affectedRows:0},this.writePacket(d.OK.toPacket(e,this.serverConfig.encoding))}writeError(e){let t=this.serverConfig?this.serverConfig.encoding:`cesu8`;this.writePacket(d.Error.toPacket(e,t))}serverHandshake(e){return this.serverConfig=e,this.serverConfig.encoding=m[this.serverConfig.characterSet],this.addCommand(new f.ServerHandshake(e))}end(e){if(this.config.isServer){this._closing=!0;let e=new a;return setImmediate(()=>{this.stream.end(),e.emit(`end`)}),e}let t=this.addCommand(new f.Quit(e));return this.addCommand=this._addCommandClosedState,t}static createQuery(e,t,n,r){let i={rowsAsArray:r.rowsAsArray,infileStreamFactory:r.infileStreamFactory};return typeof e==`object`?(i={...i,...e,sql:e.sql,values:e.values},typeof t==`function`?n=t:t!==void 0&&(i.values=t)):typeof t==`function`?(n=t,i.sql=e,i.values=void 0):(i.sql=e,i.values=t),new f.Query(i,n)}static statementKey(e){return`${typeof e.nestTables}/${e.nestTables}/${e.rowsAsArray}${e.sql}`}}})),ur=s(((e,t)=>{var n=gr().Connection,r=class extends n{constructor(e,t){super(t),this._pool=e,this.lastActiveTime=Date.now(),this.once(`end`,()=>{this._removeFromPool()}),this.once(`error`,()=>{this._removeFromPool()})}release(){!this._pool||this._pool._closed||(this.lastActiveTime=Date.now(),this._pool.releaseConnection(this))}promise(e){let t=Q().PromisePoolConnection;return new t(this,e)}end(){let e=Error(`Calling conn.end() to release a pooled connection is deprecated. In next version calling conn.end() will be restored to default conn.end() behavior. Use conn.release() instead.`);this.emit(`warn`,e),console.warn(e.message),this.release()}destroy(){this._removeFromPool(),super.destroy()}_removeFromPool(){if(!this._pool||this._pool._closed)return;let e=this._pool;this._pool=null,e._removeConnection(this)}};r.statementKey=n.statementKey,t.exports=r,r.prototype._realEnd=n.prototype.end})),dr=s(((e,t)=>{var n=Rt(),r=gr(),i=H().EventEmitter,a=ur(),o=Ve(),s=lr();function c(e,t){let n=e.length;for(let r=0;r<n;r++)if(e.get(r)===t){e.removeOne(r);break}}t.exports=class extends i{constructor(e){super(),this.config=e.config,this.config.connectionConfig.pool=this,this._allConnections=new o,this._freeConnections=new o,this._connectionQueue=new o,this._closed=!1,this.config.maxIdle<this.config.connectionLimit&&this._removeIdleTimeoutConnections()}promise(e){let t=Q().PromisePool;return new t(this,e)}getConnection(e){if(this._closed)return n.nextTick(()=>e(Error(`Pool is closed.`)));let t;return this._freeConnections.length>0?(t=this._freeConnections.pop(),this.emit(`acquire`,t),n.nextTick(()=>e(null,t))):this.config.connectionLimit===0||this._allConnections.length<this.config.connectionLimit?(t=new a(this,{config:this.config.connectionConfig}),this._allConnections.push(t),t.connect(n=>this._closed?e(Error(`Pool is closed.`)):n?e(n):(this.emit(`connection`,t),this.emit(`acquire`,t),e(null,t)))):this.config.waitForConnections?this.config.queueLimit&&this._connectionQueue.length>=this.config.queueLimit?e(Error(`Queue limit reached.`)):(this.emit(`enqueue`),this._connectionQueue.push(e)):n.nextTick(()=>e(Error(`No connections available.`)))}releaseConnection(e){let t;e._pool?this._connectionQueue.length?(t=this._connectionQueue.shift(),n.nextTick(t.bind(null,null,e))):(this._freeConnections.push(e),this.emit(`release`,e)):this._connectionQueue.length&&(t=this._connectionQueue.shift(),n.nextTick(this.getConnection.bind(this,t)))}end(e){this._closed=!0,clearTimeout(this._removeIdleTimeoutConnectionsTimer),typeof e!=`function`&&(e=function(e){if(e)throw e});let t=!1,n=0,r,i=function(r){if(!t&&(r||++n>=this._allConnections.length)){t=!0,e(r);return}}.bind(this);if(this._allConnections.length===0){i();return}for(let e=0;e<this._allConnections.length;e++)r=this._allConnections.get(e),r._realEnd(i)}query(e,t,n){let r=s.createQuery(e,t,n,this.config.connectionConfig);return r.namedPlaceholders===void 0&&(r.namedPlaceholders=this.config.connectionConfig.namedPlaceholders),this.getConnection((e,t)=>{if(e){typeof r.onResult==`function`?r.onResult(e):r.emit(`error`,e);return}try{t.query(r).once(`end`,()=>{t.release()})}catch(e){throw t.release(),e}}),r}execute(e,t,n){typeof t==`function`&&(n=t,t=[]),this.getConnection((r,i)=>{if(r)return n(r);try{i.execute(e,t,n).once(`end`,()=>{i.release()})}catch(e){return i.release(),n(e)}})}_removeConnection(e){c(this._allConnections,e),c(this._freeConnections,e),this.releaseConnection(e)}_removeIdleTimeoutConnections(){this._removeIdleTimeoutConnectionsTimer&&clearTimeout(this._removeIdleTimeoutConnectionsTimer),this._removeIdleTimeoutConnectionsTimer=setTimeout(()=>{try{for(;this._freeConnections.length>this.config.maxIdle&&Date.now()-this._freeConnections.get(0).lastActiveTime>this.config.idleTimeout;)this._freeConnections.get(0).destroy()}finally{this._removeIdleTimeoutConnections()}},1e3)}format(e,t){return r.format(e,t,this.config.connectionConfig.stringifyObjects,this.config.connectionConfig.timezone)}escape(e){return r.escape(e,this.config.connectionConfig.stringifyObjects,this.config.connectionConfig.timezone)}escapeId(e){return r.escapeId(e,!1)}}})),fr=s(((e,t)=>{var n=or();t.exports=class{constructor(e){typeof e==`string`&&(e=n.parseUrl(e)),this.connectionConfig=new n(e),this.waitForConnections=e.waitForConnections===void 0?!0:!!e.waitForConnections,this.connectionLimit=isNaN(e.connectionLimit)?10:Number(e.connectionLimit),this.maxIdle=isNaN(e.maxIdle)?this.connectionLimit:Number(e.maxIdle),this.idleTimeout=isNaN(e.idleTimeout)?6e4:Number(e.idleTimeout),this.queueLimit=isNaN(e.queueLimit)?0:Number(e.queueLimit)}}})),pr=s(((e,t)=>{var n=Rt(),r=dr(),i=fr(),a=lr(),o=H().EventEmitter,s={RR(){let e=0;return t=>t[e++%t.length]},RANDOM(){return e=>e[Math.floor(Math.random()*e.length)]},ORDER(){return e=>e[0]}},c=class{constructor(e,t,n){this._cluster=e,this._pattern=t,this._selector=s[n]()}getConnection(e){let t=this._getClusterNode();return t===null?e(Error(`Pool does Not exists.`)):this._cluster._getConnection(t,(t,n)=>t?e(t):n===`retry`?this.getConnection(e):e(null,n))}query(e,t,n){let r=a.createQuery(e,t,n,{});return this.getConnection((e,t)=>{if(e){typeof r.onResult==`function`?r.onResult(e):r.emit(`error`,e);return}try{t.query(r).once(`end`,()=>{t.release()})}catch(e){throw t.release(),e}}),r}execute(e,t,n){typeof t==`function`&&(n=t,t=[]),this.getConnection((r,i)=>{if(r)return n(r);try{i.execute(e,t,n).once(`end`,()=>{i.release()})}catch(e){throw i.release(),e}})}_getClusterNode(){let e=this._cluster._findNodeIds(this._pattern);if(e.length===0)return null;let t=e.length===1?e[0]:this._selector(e);return this._cluster._getNode(t)}};t.exports=class extends o{constructor(e){super(),e||={},this._canRetry=e.canRetry===void 0?!0:e.canRetry,this._removeNodeErrorCount=e.removeNodeErrorCount||5,this._defaultSelector=e.defaultSelector||`RR`,this._closed=!1,this._lastId=0,this._nodes={},this._serviceableNodeIds=[],this._namespaces={},this._findCaches={}}of(e,t){e||=`*`,t||=this._defaultSelector,t=t.toUpperCase(),!s[t]===`undefined`&&(t=this._defaultSelector);let n=e+t;return this._namespaces[n]===void 0&&(this._namespaces[n]=new c(this,e,t)),this._namespaces[n]}add(e,t){typeof e==`object`&&(t=e,e=`CLUSTER::${++this._lastId}`),this._nodes[e]===void 0&&(this._nodes[e]={id:e,errorCount:0,pool:new r({config:new i(t)})},this._serviceableNodeIds.push(e),this._clearFindCaches())}getConnection(e,t,n){let r;typeof e==`function`?(n=e,r=this.of()):(typeof t==`function`&&(n=t,t=this._defaultSelector),r=this.of(e,t)),r.getConnection(n)}end(e){let t=e===void 0?e=>{if(e)throw e}:e;if(this._closed){n.nextTick(t);return}this._closed=!0;let r=!1,i=0,a=e=>{if(!r&&(e||--i<=0))return r=!0,t(e)};for(let e in this._nodes)i++,this._nodes[e].pool.end(a);i===0&&n.nextTick(a)}_findNodeIds(e){if(this._findCaches[e]!==void 0)return this._findCaches[e];let t;if(e===`*`)t=this._serviceableNodeIds;else if(this._serviceableNodeIds.indexOf(e)!==-1)t=[e];else{let n=e.substring(e.length-1,0);t=this._serviceableNodeIds.filter(e=>e.startsWith(n))}return this._findCaches[e]=t,t}_getNode(e){return this._nodes[e]||null}_increaseErrorCount(e){if(++e.errorCount>=this._removeNodeErrorCount){let t=this._serviceableNodeIds.indexOf(e.id);t!==-1&&(this._serviceableNodeIds.splice(t,1),delete this._nodes[e.id],this._clearFindCaches(),e.pool.end(),this.emit(`remove`,e.id))}}_decreaseErrorCount(e){e.errorCount>0&&--e.errorCount}_getConnection(e,t){e.pool.getConnection((n,r)=>n?(this._increaseErrorCount(e),this._canRetry?(this.emit(`warn`,n),console.warn(`[Error] PoolCluster : ${n}`),t(null,`retry`)):t(n)):(this._decreaseErrorCount(e),r._clusterId=e.id,t(null,r)))}_clearFindCaches(){this._findCaches={}}}})),mr=s(((e,t)=>{var n=require("net"),r=H().EventEmitter,i=lr(),a=or();t.exports=class extends r{constructor(){super(),this.connections=[],this._server=n.createServer(this._handleConnection.bind(this))}_handleConnection(e){let t=new i({config:new a({stream:e,isServer:!0})});this.emit(`connection`,t)}listen(e){return this._port=e,this._server.listen.apply(this._server,arguments),this}close(e){this._server.close(e)}}})),hr=s(((e,t)=>{t.exports={caching_sha2_password:dn(),mysql_clear_password:pn(),mysql_native_password:fn(),sha256_password:un()}})),gr=s((e=>{var t=Be(),n=lr(),r=or(),i=wn();e.createConnection=function(e){return new n({config:new r(e)})},e.connect=e.createConnection,e.Connection=n,e.ConnectionConfig=r;var a=dr(),o=pr();e.createPool=function(e){return new a({config:new(fr())(e)})},e.createPoolCluster=function(e){return new(pr())(e)},e.createQuery=n.createQuery,e.Pool=a,e.PoolCluster=o,e.createServer=function(e){let t=new(mr());return e&&t.on(`connection`,e),t},e.PoolConnection=ur(),e.authPlugins=hr(),e.escape=t.escape,e.escapeId=t.escapeId,e.format=t.format,e.raw=t.raw,e.__defineGetter__(`createConnectionPromise`,()=>Q().createConnection),e.__defineGetter__(`createPoolPromise`,()=>Q().createPool),e.__defineGetter__(`createPoolClusterPromise`,()=>Q().createPoolCluster),e.__defineGetter__(`Types`,()=>G()),e.__defineGetter__(`Charsets`,()=>bn()),e.__defineGetter__(`CharsetToEncoding`,()=>Y()),e.setMaxParserCache=function(e){i.setMaxCache(e)},e.clearParserCache=function(){i.clearCache()}})),Q=s((e=>{var t=gr(),n=H().EventEmitter,r=wn();function i(e,t,n){return function(r,i,a){r?(n.message=r.message,n.code=r.code,n.errno=r.errno,n.sql=r.sql,n.sqlState=r.sqlState,n.sqlMessage=r.sqlMessage,t(n)):e([i,a])}}function a(e,t,n){let r={};t.on(`newListener`,i=>{n.indexOf(i)>=0&&!t.listenerCount(i)&&e.on(i,r[i]=function(){let e=[].slice.call(arguments);e.unshift(i),t.emit.apply(t,e)})}).on(`removeListener`,i=>{n.indexOf(i)>=0&&!t.listenerCount(i)&&(e.removeListener(i,r[i]),delete r[i])})}var o=class{constructor(e,t){this.statement=e,this.Promise=t}execute(e){let t=this.statement,n=Error();return new this.Promise((r,a)=>{let o=i(r,a,n);e?t.execute(e,o):t.execute(o)})}close(){return new this.Promise(e=>{this.statement.close(),e()})}},s=class extends n{constructor(e,t){super(),this.connection=e,this.Promise=t||Promise,a(e,this,[`error`,`drain`,`connect`,`end`,`enqueue`])}release(){this.connection.release()}query(e,t){let n=this.connection,r=Error();if(typeof t==`function`)throw Error(`Callback function is not available with promise clients.`);return new this.Promise((a,o)=>{let s=i(a,o,r);t===void 0?n.query(e,s):n.query(e,t,s)})}execute(e,t){let n=this.connection,r=Error();if(typeof t==`function`)throw Error(`Callback function is not available with promise clients.`);return new this.Promise((a,o)=>{let s=i(a,o,r);t===void 0?n.execute(e,s):n.execute(e,t,s)})}end(){return new this.Promise(e=>{this.connection.end(e)})}beginTransaction(){let e=this.connection,t=Error();return new this.Promise((n,r)=>{let a=i(n,r,t);e.beginTransaction(a)})}commit(){let e=this.connection,t=Error();return new this.Promise((n,r)=>{let a=i(n,r,t);e.commit(a)})}rollback(){let e=this.connection,t=Error();return new this.Promise((n,r)=>{let a=i(n,r,t);e.rollback(a)})}ping(){let e=this.connection,t=Error();return new this.Promise((n,r)=>{e.ping(e=>{e?(t.message=e.message,t.code=e.code,t.errno=e.errno,t.sqlState=e.sqlState,t.sqlMessage=e.sqlMessage,r(t)):n(!0)})})}connect(){let e=this.connection,t=Error();return new this.Promise((n,r)=>{e.connect((e,i)=>{e?(t.message=e.message,t.code=e.code,t.errno=e.errno,t.sqlState=e.sqlState,t.sqlMessage=e.sqlMessage,r(t)):n(i)})})}prepare(e){let t=this.connection,n=this.Promise,r=Error();return new this.Promise((i,a)=>{t.prepare(e,(e,t)=>{e?(r.message=e.message,r.code=e.code,r.errno=e.errno,r.sqlState=e.sqlState,r.sqlMessage=e.sqlMessage,a(r)):i(new o(t,n))})})}changeUser(e){let t=this.connection,n=Error();return new this.Promise((r,i)=>{t.changeUser(e,e=>{e?(n.message=e.message,n.code=e.code,n.errno=e.errno,n.sqlState=e.sqlState,n.sqlMessage=e.sqlMessage,i(n)):r()})})}get config(){return this.connection.config}get threadId(){return this.connection.threadId}};function c(e){let n=t.createConnection(e),r=Error(),i=e.Promise||Promise;if(!i)throw Error(`no Promise implementation available.Use promise-enabled node version or pass userland Promise implementation as parameter, for example: { Promise: require('bluebird') }`);return new i((e,t)=>{n.once(`connect`,()=>{e(new s(n,i))}),n.once(`error`,e=>{r.message=e.message,r.code=e.code,r.errno=e.errno,r.sqlState=e.sqlState,t(r)})})}(function(e){for(let n=0;e&&n<e.length;n++){let r=e[n];typeof t.Connection.prototype[r]==`function`&&s.prototype[r]===void 0&&(s.prototype[r]=(function(e){return function(){return t.Connection.prototype[e].apply(this.connection,arguments)}})(r))}})([`close`,`createBinlogStream`,`destroy`,`escape`,`escapeId`,`format`,`pause`,`pipe`,`resume`,`unprepare`]);var l=class extends s{constructor(e,t){super(e,t)}destroy(){return t.PoolConnection.prototype.destroy.apply(this.connection,arguments)}},u=class extends n{constructor(e,t){super(),this.pool=e,this.Promise=t||Promise,a(e,this,[`acquire`,`connection`,`enqueue`,`release`])}getConnection(){let e=this.pool;return new this.Promise((t,n)=>{e.getConnection((e,r)=>{e?n(e):t(new l(r,this.Promise))})})}releaseConnection(e){e instanceof l&&e.release()}query(e,t){let n=this.pool,r=Error();if(typeof t==`function`)throw Error(`Callback function is not available with promise clients.`);return new this.Promise((a,o)=>{let s=i(a,o,r);t===void 0?n.query(e,s):n.query(e,t,s)})}execute(e,t){let n=this.pool,r=Error();if(typeof t==`function`)throw Error(`Callback function is not available with promise clients.`);return new this.Promise((a,o)=>{let s=i(a,o,r);t?n.execute(e,t,s):n.execute(e,s)})}end(){let e=this.pool,t=Error();return new this.Promise((n,r)=>{e.end(e=>{e?(t.message=e.message,t.code=e.code,t.errno=e.errno,t.sqlState=e.sqlState,t.sqlMessage=e.sqlMessage,r(t)):n()})})}};function d(e){let n=t.createPool(e),r=e.Promise||Promise;if(!r)throw Error(`no Promise implementation available.Use promise-enabled node version or pass userland Promise implementation as parameter, for example: { Promise: require('bluebird') }`);return new u(n,r)}(function(e){for(let n=0;e&&n<e.length;n++){let r=e[n];typeof t.Pool.prototype[r]==`function`&&u.prototype[r]===void 0&&(u.prototype[r]=(function(e){return function(){return t.Pool.prototype[e].apply(this.pool,arguments)}})(r))}})([`escape`,`escapeId`,`format`]);var f=class e extends n{constructor(e,t){super(),this.poolCluster=e,this.Promise=t||Promise,a(e,this,[`warn`,`remove`])}getConnection(){let e=this.poolCluster;return new this.Promise((t,n)=>{e.getConnection((e,r)=>{e?n(e):t(new l(r,this.Promise))})})}query(e,t){let n=this.poolCluster,r=Error();if(typeof t==`function`)throw Error(`Callback function is not available with promise clients.`);return new this.Promise((a,o)=>{let s=i(a,o,r);n.query(e,t,s)})}execute(e,t){let n=this.poolCluster,r=Error();if(typeof t==`function`)throw Error(`Callback function is not available with promise clients.`);return new this.Promise((a,o)=>{let s=i(a,o,r);n.execute(e,t,s)})}of(t,n){return new e(this.poolCluster.of(t,n),this.Promise)}end(){let e=this.poolCluster,t=Error();return new this.Promise((n,r)=>{e.end(e=>{e?(t.message=e.message,t.code=e.code,t.errno=e.errno,t.sqlState=e.sqlState,t.sqlMessage=e.sqlMessage,r(t)):n()})})}};(function(e){for(let n=0;e&&n<e.length;n++){let r=e[n];typeof t.PoolCluster.prototype[r]==`function`&&f.prototype[r]===void 0&&(f.prototype[r]=(function(e){return function(){return t.PoolCluster.prototype[e].apply(this.poolCluster,arguments)}})(r))}})([`add`]);function p(e){let n=t.createPoolCluster(e),r=e&&e.Promise||Promise;if(!r)throw Error(`no Promise implementation available.Use promise-enabled node version or pass userland Promise implementation as parameter, for example: { Promise: require('bluebird') }`);return new f(n,r)}e.createConnection=c,e.createPool=d,e.createPoolCluster=p,e.escape=t.escape,e.escapeId=t.escapeId,e.format=t.format,e.raw=t.raw,e.PromisePool=u,e.PromiseConnection=s,e.PromisePoolConnection=l,e.__defineGetter__(`Types`,()=>G()),e.__defineGetter__(`Charsets`,()=>bn()),e.__defineGetter__(`CharsetToEncoding`,()=>Y()),e.setMaxParserCache=function(e){r.setMaxCache(e)},e.clearParserCache=function(){r.clearCache()}})),_r=Q(),vr=`^-?[0-9]+(.[0-9]+)?$`;async function yr(e){let t=await(0,_r.createConnection)(e);try{return await t.connect(),await t.query(`SELECT 1`),t}catch(e){throw await t.end(),e instanceof Error?Error(`MySQL connection error: ${e.message}`):e}}function br(e,t){return`${e}_${t}_enum`}function xr(e,t){return e===`VIRTUAL GENERATED`?`GENERATED ALWAYS AS (${t}) VIRTUAL`:e===`STORED GENERATED`?`GENERATED ALWAYS AS (${t}) STORED`:e.includes(`on update CURRENT_TIMESTAMP`)?`on update CURRENT_TIMESTAMP`:``}function Sr(e,t){return e===null?null:{value:e,type:t}}function Cr(e,t,n,r,i,a){if(r===`enum`)return br(e,t);let o=xr(i,a);return o?`${n} ${o}`:n}function wr(e){let{tableName:t,columnName:n,columnDefault:r,defaultValueType:i,columnIsNullable:a,columnType:o,columnDataType:s,columnComment:c,columnExtra:l,generationExpression:u}=e,d=Cr(t,n,o,s,l,u),f=Sr(r,i);return{name:n,type:{type_name:d,schemaName:null},dbdefault:f,not_null:a!==`YES`,increment:l===`auto_increment`,note:{value:c||``}}}function Tr(e,t,n){return t?{value:t,type:`expression`}:n?{value:`${e}(${n})`,type:`expression`}:e?{value:e,type:`column`}:null}async function Er(e,t){let n=(await e.query(`
  ...
  `,[vr,t]))[0],r={},i={};return n.forEach(e=>{let{tableName:t,tableComment:n}=e,a=t;r[a]||(r[a]={name:t,note:{value:n||``}}),i[a]||(i[a]=[]);let o=wr(e);i[a].push(o)}),{tableList:Object.values(r),fieldMap:i}}async function Dr(e,t){return(await e.query(`
    select
      t.table_name as tableName,
      c.column_name as columnName,
    ...
    order by
      t.table_name, c.ordinal_position;
  `,[t]))[0].map(e=>{let{tableName:t,columnName:n,rawValues:r}=e,i=r.slice(1,-1).split(`,`).map(e=>({name:e.slice(1,-1)}));return{name:br(t,n),values:i}})}async function Or(e,t){let n=(await e.query(`
    with
      pk_fk_uniques as (
  ...
  `,[t,t]))[0].reduce((e,t)=>{let{tableName:n,idxName:r,idxType:i,isIdxUnique:a,columnName:o,idxExpression:s,idxSubPart:c}=t,l=n;e[l]||(e[l]={}),e[l][r]||(e[l][r]={name:r,type:i,columns:[],unique:!!a});let u=e[l][r],d=Tr(o,s,c);return d&&u.columns.push(d),e},{}),r={};return Object.keys(n).forEach(e=>{r[e]=Re(Object.values(n[e]))}),r}async function kr(e,t){let n=(await e.query(`
    select
      tc.table_name as tableName,
      tc.constraint_name as constraintName,
    ...
    order by tc.table_name, tc.constraint_name;
  `,[t]))[0],r=n.filter(e=>e.columnCount===1),i=n.filter(e=>e.columnCount>1).reduce((e,t)=>{let{tableName:n,constraintName:r,columnNames:i,constraintType:a}=t,o=n;e[o]||(e[o]={}),e[o][r]||(e[o][r]={name:r}),a===`PRIMARY KEY`&&(e[o][r].pk=!0),a===`UNIQUE`&&(e[o][r].unique=!0);let s=i.split(`,`).map(e=>({type:`column`,value:e}));return e[o][r].columns=s,e},{}),a={};return Object.keys(i).forEach(e=>{a[e]=Re(Object.values(i[e]))}),{compositeConstraintMap:a,primaryAndUniqueConstraintMap:r.reduce((e,t)=>{let{tableName:n,columnNames:r,constraintType:i}=t,a=n;return e[a]||(e[a]={}),r.split(`,`).forEach(t=>{e[a][t]||(e[a][t]={checks:[]}),i===`PRIMARY KEY`&&(e[a][t].pk=!0),i===`UNIQUE`&&!e[a][t].pk&&(e[a][t].unique=!0)}),e},{})}}function Ar(e){return[...e.matchAll(/`(?:``|[^`])*`/g)].map(e=>e.toString().slice(1,-1))}async function jr(e,t){let n=(await e.query(`
    select
  ...
  `,[t]))[0],r={},i={};return n.forEach(e=>{let{constraintName:t,tableName:n,checkClause:a}=e,o=n,s=Ar(a);if(s.length===1){let e=s[0];i[o]||(i[o]={}),i[o][e]||(i[o][e]={checks:[]}),i[o][e].checks.push({name:t,expression:a.slice(1,-1)});return}r[o]||(r[o]=[]),r[o].push({name:t,expression:a.slice(1,-1)})}),{checks:r,tableConstraints:i}}async function Mr(e,t){return(await e.query(`
    select
    ...
    order by
      rc.table_name;
  `,[t]))[0].map(e=>{let{constraintName:t,onDelete:n,onUpdate:r,foreignTableName:i,foreignColumnNames:a,refTableName:o,refColumnNames:s}=e;return{name:t,endpoints:[{tableName:i,fieldNames:a.split(`,`),relation:`0..*`},{tableName:o,fieldNames:s.split(`,`),relation:`0..1`}],onDelete:n===`NO ACTION`?null:n,onUpdate:r===`NO ACTION`?null:r}})}function Nr(e,t){let n=Object.assign(e,{});return Object.keys(t).forEach(e=>{let r=t[e];if(!n[e]){n[e]=r;return}n[e].push(...r)}),n}async function Pr(e){let t=await yr(e),{database:n}=t.config;if(!n)throw Error(`Cannot get schema name from the connection`);try{let[{tableList:e,fieldMap:r},i,a,{primaryAndUniqueConstraintMap:o,compositeConstraintMap:s},c,{checks:l,tableConstraints:u}]=await Promise.all([Er(t,n),Dr(t,n),Or(t,n),kr(t,n),Mr(t,n),jr(t,n)]),d=Nr(a,s),f={...o};return Object.keys(u).forEach(e=>{f[e]||(f[e]={}),Object.keys(u[e]).forEach(t=>{f[e][t]||(f[e][t]={checks:[]}),f[e][t].checks.push(...u[e][t].checks)})}),{tables:e,fields:r,refs:c,enums:i,indexes:d,tableConstraints:f,checks:l}}finally{await t.end()}}var $=`@@@@@@@@`,Fr={outFormat:h.default.OUT_FORMAT_OBJECT};function Ir(e){let{username:t,password:n,dbidentifier:r}=e.match(/^(?<username>[^/@:]+)\/(?<password>[^/@:]+)@(\/\/)?(?<dbidentifier>.+)$/)?.groups||{};if(!t||!n||!r)throw Error(`Invalid Easy Connect string. Expect a string of format 'username/password@[//]host[:port][/database]'`);return{username:t,password:n,dbidentifier:r}}async function Lr(e){let t=`
  ...
  `,[],Fr),n={},r={};return t.rows?.forEach(e=>{let{index_name:t,table_name:n,index_type:i,is_unique:a,column_name:o,column_expression:s}=e,c=t,l=n,u=i,d=!!a;if(s){r[c]||(r[c]={table:l,type:u,unique:d,columns:[]}),r[c].columns.push({type:`expression`,value:s});return}if(o){r[c]||(r[c]={table:l,type:u,unique:d,columns:[]}),r[c].columns.push({type:`column`,value:o});return}}),Object.entries(r).forEach(([e,{table:t,type:r,unique:i,columns:a}])=>{let o={name:e,type:r,unique:i,columns:a};n[t]||(n[t]=[]),n[t].push(o)}),n}async function zr(e){let t=[],n=`
    ...
    ORDER BY
      ...
      obj_child.OBJECT_ID,
      c.CONSTRAINT_NAME
  `;return(await e.execute(n,[],Fr)).rows?.forEach(e=>{let{fk_name:n,child_table:r,child_columns:i,parent_table:a,parent_columns:o,delete_rule:s}=e,c={tableName:r,schemaName:``,fieldNames:i.split($),relation:`0..*`},l={tableName:a,schemaName:``,fieldNames:o.split($),relation:`0..1`};t.push({name:n,endpoints:[c,l],onDelete:s===`NO ACTION`?null:s,onUpdate:null})}),t}async function Br(e){let t={},n=(await e.execute(`
    SELECT
  ...
  `,[],Fr)).rows?.reduce((e,n)=>{let{table_name:r,table_comment:i}=n;e[r]||(e[r]={name:r,schemaName:``,note:i?{value:i}:{value:``}}),t[r]||(t[r]=[]);let a=Hr(n);return t[r].push(a),e},{})||{};return{tables:Object.values(n),fields:t}}function Vr(e){if(e==null)return`expression`;let t=e.trim();return/^'.*'$/.test(t)?`string`:/^[0-9]+$/.test(t)||/^[0-9]*\.[0-9]*$/.test(t)?`number`:`expression`}function Hr(e){let{column_name:t,data_type:n,data_length:r,data_precision:i,data_scale:a,identity_increment:o,is_nullable:s,data_default:c,column_comment:l}=e,u=Vr(c),d=c&&!o?Ur(c,u):null;return{name:t,type:{type_name:$r(n,r,i,a),schemaName:null},dbdefault:d,not_null:!s,increment:!!o,note:l?{value:l}:{value:``}}}function Ur(e,t){return e===null?null:t===`string`?{value:e.trim().slice(1,-1).replaceAll(`''`,`'`),type:t}:{value:e,type:t}}var Wr=new Set([`char`,`varchar2`,`nchar`,`nvarchar2`,`raw`,`urowid`,`character varying`,`character`,`char varying`,`nchar varying`,`varchar`,`national character varying`,`national character`,`national char varying`,`national char`]),Gr=new Set([`float`]),Kr=`timestamp with local time zone`,qr=`timestamp with time zone`,Jr=`timestamp`,Yr=`interval year to month`,Xr=`interval day to second`,Zr=new Set([`number`,`numeric`,`decimal`,`dec`]);function Qr(e){let t=e.split(` `).filter(Boolean).join(` `).toLowerCase();switch(t){case`anydata`:return`AnyData`;case`anytype`:return`AnyType`;case`anydataset`:return`AnyDataSet`;case`xmltype`:return`XMLType`;case`uritype`:return`URIType`;case`sdo_geometry`:return`SDO_Geometry`;case`sdo_topo_geometry`:return`SDO_Topo_Geometry`;case`sdo_georaster`:return`SDO_GeoRaster`;default:return t}}function $r(e,t,n,r){let i=Qr(e);return i===Kr?r===null?i:`timestamp (${r}) with local time zone`:i===qr?r===null?i:`timestamp (${r}) with time zone`:i===Jr?r===null?i:`timestamp (${r})`:i===Yr?n===null?i:`interval year (${n}) to month`:i===Xr?n!==null&&r!==null?`interval day (${n}) to second (${r})`:n===null?r===null?i:`interval day to second (${r})`:`interval day (${n}) to second`:Wr.has(i)?t?`${i}(${t})`:i:Gr.has(i)?n===null?i:`${i}(${n})`:Zr.has(i)?n!==null&&r!==null?`${i}(${n}, ${r})`:n===null?i:`${i}(${n})`:i}var ei=async(e,t,n)=>{let r=await(0,h.getConnection)({username:e,password:t,connectionString:n});try{return await r.execute(`SELECT 1 FROM DUAL`),r}catch(e){throw await r.close(),e instanceof Error?Error(`OracleSQL connection error: ${e.message}`):e}};async function ti(e){let{username:t,password:n,dbidentifier:r}=Ir(e),i=await ei(t,n,r),a=Br(i),o=Lr(i),s=zr(i),c=Rr(i),l=await Promise.all([a,o,s,c]),{tables:u,fields:d}=l[0],{indexes:f,tableConstraints:p,checks:m}=l[1],h=l[2],g=l[3];return Object.keys(f).forEach(e=>{g[e]?g[e].push(...f[e]):g[e]=f[e]}),await i.close(),{tables:u,fields:d,refs:h,enums:[],indexes:g,tableConstraints:p,checks:m}}var ni=async e=>{let t=new g.Client(e);try{return await t.connect(),await t.query(`SELECT 1`),t}catch(e){throw await t.end(),e instanceof Error?Error(`PostgreSQL connection error: ${e}`):e}},ri=e=>e===`YES`,ii=(e,t,n,r,i)=>e===`ARRAY`?`${t.slice(1,t.length)}[]`:n?`${t}(${n})`:r&&i?`${t}(${r},${i})`:t,ai=(e,t,n)=>{if(e===`ARRAY`)return{type:n,value:`ARRAY[${t.slice(6,-1).split(`,`).map(e=>e.split(`::`)[0]).join(`, `)}]`};if(n===`string`){let n=t.split(`::`)[0];return{type:e===`json`||e===`jsonb`?`expression`:`string`,value:n.slice(1,-1)}}return{type:n,value:t}},oi=e=>{let{column_name:t,data_type:n,character_maximum_length:r,numeric_precision:i,numeric_scale:a,udt_schema:o,udt_name:s,identity_increment:c,is_nullable:l,column_default:u,default_type:d,column_comment:f}=e,p=u&&d!==`increment`?ai(n,u,d):null;return{name:t,type:n===`USER-DEFINED`?{type_name:s,schemaName:o}:{type_name:ii(n,s,r,i,a),schemaName:null},dbdefault:p,not_null:!ri(l),increment:!!c||d===`increment`,note:f?{value:f}:{value:``}}},si=async(e,t)=>{let n={},r=`
    WITH
      comments AS (
    ...
    ORDER BY
      ...
      c.ordinal_position
    ;
  `,i=(await e.query(r)).rows.reduce((e,t)=>{let{table_schema:r,table_name:i,table_comment:a}=t,o=`${r}.${i}`;e[o]||(e[o]={name:i,schemaName:r,note:a?{value:a}:{value:``}}),n[o]||(n[o]=[]);let s=oi(t);return n[o].push(s),e},{});return{tables:Object.values(i),fields:n}},ci=async(e,t)=>{let n=[],r=`
    SELECT
      tc.table_schema,
      tc.table_name,
  ...
  `,c=await e.query(s),l={};return c.rows.forEach(e=>{let{table_schema:t,table_name:n,check_name:r,check_definition:i,column_name:a,is_column_constraint:s}=e;if(typeof t!=`string`||typeof n!=`string`||typeof i!=`string`||!i.match(/CHECK \(\(.*\)\)/)||s&&typeof a!=`string`)return;let c=`${t}.${n}`;if(s){o[c]||(o[c]={}),o[c][a]||(o[c][a]={checks:[]}),o[c][a].checks.push({name:r||void 0,expression:i.slice(8,-2)});return}l[c]||(l[c]=[]),l[c].push({name:r||void 0,expression:i.slice(8,-2)})}),{indexes:a,tableConstraints:o,checks:l}},ui=async(e,t)=>{let n=`
    ...
    ORDER BY
      ...
      sort_order;
    ;
  `,r=(await e.query(n)).rows.reduce((e,t)=>{let{schema_name:n,enum_type:r,enum_value:i}=t,a=`${n}.${r}`;return e[a]||(e[a]={name:r,schemaName:n,values:[]}),e[a].values.push({name:i}),e},{});return Object.values(r)},di=async e=>{let{connectionString:t,schemas:n}=le(e,`jdbc`),r=await ni(t);try{let e=si(r,n),t=li(r,n),i=ci(r,n),a=ui(r,n),o=await Promise.all([e,t,i,a]),{tables:s,fields:c}=o[0],{indexes:l,tableConstraints:u,checks:d}=o[1];return{tables:s,fields:c,refs:o[2],enums:o[3],indexes:l,tableConstraints:u,checks:d}}finally{await r.end()}},fi=e=>{let t={},n=/([^;=]+)=([^;]*)/g,r;for(;(r=n.exec(e))!==null;)t[r[1].trim()]=r[2].trim();return t},pi=async e=>new Promise((t,n)=>{console.log(`Attempting to connect...`),e.connect(e=>{e?n(e):t()})}),mi=(e,t)=>new Promise((n,r)=>{console.log(`Executing query...`),e.execute({sqlText:t,complete:(e,t,i)=>{e?r(e):(console.log(`Query executed successfully.`),i&&n(i))}})}),hi=e=>[`ERROR`,`WARN`,`INFO`,`DEBUG`,`TRACE`].includes(e),gi=async e=>{let t=hi(e.LOG_LEVEL)?e.LOG_LEVEL:`INFO`,n=e.IS_DEBUG_MODE===`true`;_.default.configure({logLevel:t,additionalLogToConsole:n});let r={};switch(e.AUTHENTICATOR){case`SNOWFLAKE_JWT`:r={privateKeyPath:e.PRIVATE_KEY_PATH,privateKeyPass:e.PASSPHRASE};break;case`SNOWFLAKE`:case void 0:r={password:e.PWD};break;default:throw Error(`Unsupported authenticator`)}let i={authenticator:e.AUTHENTICATOR,account:e.SERVER,username:e.UID,database:e.DATABASE,warehouse:e.WAREHOUSE,sfRetryMaxLoginRetries:3,timeout:1e4,...r},a=_.default.createConnection(i);return await pi(a),await mi(a,`SELECT CURRENT_VERSION();`),a},_i=e=>e===`YES`,vi=(e,t,n,r)=>t?`${e}(${t})`:n&&r?`${e}(${n},${r})`:e,yi=(e,t)=>t===`string`?{type:t,value:e.slice(1,-1)}:{type:t,value:e},bi=e=>{let{COLUMN_NAME:t,DATA_TYPE:n,CHARACTER_MAXIMUM_LENGTH:r,NUMERIC_PRECISION:i,NUMERIC_SCALE:a,IDENTITY_INCREMENT:o,IS_NULLABLE:s,COLUMN_DEFAULT:c,DEFAULT_TYPE:l,COLUMN_COMMENT:u}=e,d=c?yi(c,l):null;return{name:t,type:{type_name:vi(n,r,i,a),schemaName:null},dbdefault:d,not_null:!_i(s),increment:!!o,note:u?{value:u}:{value:``}}},xi=async(e,t)=>{let n={},r=(await mi(e,`
    SELECT
        c.table_schema,
        c.table_name,
        c.column_name,
    ...
    ORDER BY
        ...
        t.created,
        c.ordinal_position;
  `)).reduce((e,t)=>{let{TABLE_SCHEMA:r,TABLE_NAME:i,TABLE_COMMENT:a}=t,o=`${r}.${i}`;e[o]||(e[o]={name:i,schemaName:r,note:a?{value:a}:{value:``}}),n[o]||(n[o]=[]);let s=bi(t);return n[o].push(s),e},{});return{tables:Object.values(r),fields:n}},Si=(e,t,n)=>e.reduce((e,r)=>{let{schema_name:i,table_name:a,column_name:o,constraint_name:s}=r;if(!(!(t.length>0)||t.includes(i)))return e;let c=`${i}.${a}.${s}`;if(e[c]){let{columnNames:t}=e[c];return t.push(o),e}return e[c]={schemaName:i,tableName:a,constraintName:s,columnNames:[o],type:``},e[c][n]=!0,e},{}),Ci=async(e,t,n)=>{let r=`
    SHOW PRIMARY KEYS IN DATABASE ${t};
  `,i=`
    SHOW UNIQUE KEYS IN DATABASE ${t};
  `,a=await mi(e,r),o=await mi(e,i),s=Si(a,n,`primary`),c=Si(o,n,`unique`),{indexes:l,tableConstraints:u}=[Object.values(s),Object.values(c)].flat().reduce((e,t)=>{let{schemaName:n,tableName:r,constraintName:i,columnNames:a,type:o,primary:s,unique:c}=t,l=`${n}.${r}`;if(a.length<2)return e.tableConstraints[l]={[a[0]]:{pk:s,unique:c,checks:[]}},e;let u={name:i,type:o,unique:c,pk:s,columns:a.map(e=>({type:`column`,value:e}))};return e.indexes[l]?e.indexes[l].push(u):e.indexes[l]=[u],e},{indexes:{},tableConstraints:{}});return{indexes:l,tableConstraints:u}},wi=async e=>{let t=fi(e),n=await gi(t);if(n instanceof Error)throw n;let r=t.SCHEMAS?oe(t.SCHEMAS):[],i=t.DATABASE,a=xi(n,r),o=Ci(n,i,r),s=await Promise.all([a,o]);n.destroy(e=>{if(e)throw e;console.log(`Connection destroyed successfully.`)});let{tables:c,fields:l}=s[0],{indexes:u,tableConstraints:d}=s[1];return{tables:c,fields:l,refs:[],enums:[],indexes:u,tableConstraints:d,checks:{}}},Ti=c({fetchSchemaJson:()=>Ei}),Ei=async(e,t)=>{switch(t){case`postgres`:return di(e);case`mssql`:return ge(e);case`mysql`:return Pr(e);case`snowflake`:return wi(e);case`bigquery`:return ie(e);case`oracle`:return ti(e);default:throw Error(`Unsupported database type: ${t}`)}};Object.defineProperty(exports,"connector",{enumerable:!0,get:function(){return Ti}});