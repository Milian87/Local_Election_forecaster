import { BigQuery as e } from "@google-cloud/bigquery";
import { readFile as t } from "fs/promises";
import n from "mssql";
import r, { getConnection as i } from "oracledb";
import { Client as a } from "pg";
import o from "snowflake-sdk";
//#region \0rolldown/runtime.js
var s = Object.defineProperty, c = Object.getOwnPropertyDescriptor, l = Object.getOwnPropertyNames, u = Object.prototype.hasOwnProperty, d = (e, t) => () => (e && (t = e(e = 0)), t), f = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), p = (e, t) => {
	let n = {};
...
//#endregion
//#region src/utils/credential-loader.ts
async function _(e) {
	try {
		return await t(e, { encoding: "utf8" });
	} catch (e) {
...
//#endregion
//#region src/connectors/bigquery/index.ts
async function T(t) {
	let n = {};
...
function D(e) {
	let { columnName: t, isNullable: n, dataType: r, columnDefault: i, columnDefaultType: a, columnDescription: o } = e, s = E(i, a);
	return {
		name: t,
		not_null: n === "NO",
		type: {
...
async function O(e, t, n) {
  ...
  `, [a] = await e.query({ query: i }), o = {}, s = {};
	return a.forEach((e) => {
		let { tableSchema: t, tableName: n, tableComment: r } = e, i = b(t, n);
		o[i] || (o[i] = {
			name: n,
			note: { value: r || "" },
			schemaName: t
...
async function te(e, t, n) {
  ...
  `, [a] = await e.query(i), o = a.filter((e) => e.columnCount && e.columnCount === 1), s = a.filter((e) => e.columnCount && e.columnCount > 1), c = {};
	o.forEach((e) => {
		let { tableSchema: t, tableName: n, columnNames: r } = e, i = b(t, n);
...
async function k(e) {
	let t = v(await _(e)), n = await T(t), r = await n.getProjectId(), i = (await ne(n, t.datasets)).map((e) => re(n, r, e));
	return (await Promise.all(i)).reduce((e, t) => {
		let { tables: n, fields: r, indexes: i, tableConstraints: a } = t;
		return e.tables = x(e.tables, n), e.fields = S(e.fields, r), e.indexes = C(e.indexes, i), e.tableConstraints = w(e.tableConstraints, a), e;
	}, {
		tables: [],
		fields: {},
		tableConstraints: {},
...
//#endregion
//#region src/utils/parseSchema.ts
var ie = "schemas=", A = (e) => e.toLowerCase().includes(ie), ae = (e) => e ? e.toLowerCase().split(ie)[1] : "", j = (e) => ({
	connectionString: e,
	schemas: []
}), M = (e) => e ? e.split(/,(?=(?:[^"]*(?:"[^"]*")*)*$)/).map((e) => e.trim()).map((e) => e.replace(/"/g, "")) : [], oe = (e) => {
	let t = e.split(";"), n = t.find((e) => A(e));
	return {
		connectionString: t.filter((e) => !A(e)).join(";"),
		schemas: M(ae(n))
	};
}, se = (e) => {
	let t = e.split("?"), n = t[1].split("&").find((e) => A(e));
	return {
		connectionString: t[0],
		schemas: M(ae(n))
	};
}, ce = (e, t) => A(e) ? t === "jdbc" ? se(e) : oe(e) : j(e), N = (e, t, n = "AND") => t.length === 0 ? "" : `${n} ${e} IN (${t.map((e) => `'${e}'`).join(", ")})`, le = [
	"date",
	"datetime",
	"datetime2",
	"smalldatetime",
...
}, ue = (e) => e === "YES", de = (e, t, n, r) => le.includes(e) || e === "timestamp" || e === "bit" ? e : n ? r ? `${e}(${n},${r})` : `${e}(${n})` : [
	"ntext",
	"text",
	"image"
].includes(e) ? e : t < 0 ? e === "xml" ? e : `${e}(MAX)` : t > 0 ? `${e}(${e === "nchar" || e === "nvarchar" ? t / 2 : t})` : e, fe = (e, t, n) => {
	...
	let { column_name: t, data_type: n, character_maximum_length: r, numeric_precision: i, numeric_scale: a, identity_increment: o, is_nullable: s, column_default: c, default_type: l, column_comment: u } = e, d = c && l !== "increment" ? fe(n, c, l) : null;
	return {
		name: t,
		type: {
			type_name: de(n, r, i, a),
			schemaName: null
		},
		dbdefault: d,
		not_null: !ue(s),
  ...
  `, c = await e.query(s), l = {};
	...
	let { connectionString: t, schemas: n } = ce(e, "odbc"), r = await P(t);
	try {
		let e = F(r, n), t = me(r, n), i = I(r, n), a = await Promise.all([
			e,
			t,
			i
...
}, ge = typeof global == "object" && global && global.Object === Object && global, _e = typeof self == "object" && self && self.Object === Object && self, L = (ge || _e || Function("return this")()).Symbol, ve = Object.prototype, R = ve.hasOwnProperty, z = ve.toString, B = L ? L.toStringTag : void 0;
function ye(e) {
	var t = R.call(e, B), n = e[B];
	try {
		e[B] = void 0;
		var r = !0;
	} catch {}
...
var xe = "[object Null]", Se = "[object Undefined]", Ce = L ? L.toStringTag : void 0;
function we(e) {
	return e == null ? e === void 0 ? Se : xe : Ce && Ce in Object(e) ? ye(e) : be(e);
}
//#endregion
...
var Ee = Array.isArray, De = "[object Arguments]";
function Oe(e) {
	return Te(e) && we(e) == De;
}
//#endregion
//#region ../../node_modules/lodash-es/isArguments.js
var ke = Object.prototype, Ae = ke.hasOwnProperty, je = ke.propertyIsEnumerable, Me = Oe(function() {
	return arguments;
}()) ? Oe : function(e) {
	return Te(e) && Ae.call(e, "callee") && !je.call(e, "callee");
};
//#endregion
...
var Pe = L ? L.isConcatSpreadable : void 0;
function Fe(e) {
	return Ee(e) || Me(e) || !!(Pe && e && e[Pe]);
}
//#endregion
...
function Ie(e, t, n, r, i) {
	...
	for (n ||= Fe, i ||= []; ++a < o;) {
		var s = e[a];
		t > 0 && n(s) ? t > 1 ? Ie(s, t - 1, n, r, i) : Ne(i, s) : r || (i[i.length] = s);
	}
	return i;
}
//#endregion
...
function Le(e) {
	return e != null && e.length ? Ie(e, 1) : [];
}
//#endregion
//#region ../../node_modules/sqlstring/lib/SqlString.js
var Re = /* @__PURE__ */ f(((e) => {
	...
	function T(e, t, n, r) {
		return R(ge(t, e.length - n), e, n, r);
	}
	function E(e, t, n, r) {
		return R(_e(t), e, n, r);
	}
	...
	ue("ERR_BUFFER_OUT_OF_BOUNDS", function(e) {
		return e ? `${e} is outside of buffer bounds` : "Attempt to access memory outside buffer bounds";
	}, RangeError), ue("ERR_INVALID_ARG_TYPE", function(e, t) {
		return `The "${e}" argument must be of type number. Received type ${typeof t}`;
	}, TypeError), ue("ERR_OUT_OF_RANGE", function(e, t, n) {
		let r = `The value of "${e}" is out of range.`, i = n;
		return Number.isInteger(n) && Math.abs(n) > 2 ** 32 ? i = de(String(n)) : typeof n == "bigint" && (i = String(n), (n > BigInt(2) ** BigInt(32) || n < -(BigInt(2) ** BigInt(32))) && (i = de(i)), i += "n"), r += ` It must be ${t}. Received ${i}`, r;
	}, RangeError);
	function de(e) {
	...
	function pe(e, t, n, r, i, a) {
		if (e > n || e < t) {
			...
			throw i = a > 3 ? t === 0 || t === BigInt(0) ? `>= 0${r} and < 2${r} ** ${(a + 1) * 8}${r}` : `>= -(2${r} ** ${(a + 1) * 8 - 1}${r}) and < 2 ** ${(a + 1) * 8 - 1}${r}` : `>= ${t}${r} and <= ${n}${r}`, new P.ERR_OUT_OF_RANGE("value", i, e);
		}
		fe(r, i, a);
	}
	function F(e, t) {
		if (typeof e != "number") throw new P.ERR_INVALID_ARG_TYPE(t, "number", e);
	}
	function I(e, t, n) {
		throw Math.floor(e) === e ? t < 0 ? new P.ERR_BUFFER_OUT_OF_BOUNDS() : new P.ERR_OUT_OF_RANGE(n || "offset", `>= ${+!!n} and <= ${t}`, e) : (F(e, n), new P.ERR_OUT_OF_RANGE(n || "offset", "an integer", e));
	}
	...
	var t = Ye().Buffer, n = t.isEncoding || function(e) {
	...
	t.exports = {
		...
		cp936: {
			type: "_dbcs",
			table: function() {
				return pt(), h(dt).default;
			}
		},
		gbk: {
			type: "_dbcs",
			table: function() {
				return (pt(), h(dt).default).concat((gt(), h(mt).default));
			}
		},
		xgbk: "gbk",
		isoir58: "gbk",
		...
		big5hkscs: {
			type: "_dbcs",
			table: function() {
				return (Dt(), h(Tt).default).concat((At(), h(Ot).default));
			},
			encodeSkipVals: [
				36457,
				36463,
	...
	var n = U().Buffer, r = Je(), i = t.exports;
	...
	var t = Pt(), n = He().default, r = new n({ max: 500 });
	...
	var n = Ue(), r = Ke().Buffer, i = qe(), a = Ft(), o = /* @__PURE__ */ new Date(NaN), s = "000000000000";
	function c(e, t) {
		let n = t.toString();
	...
	var n = G(), r = W(), i = Array(256), a = class e {
		constructor(e) {
			this.columns = e || [];
		}
		static toPacket(e, t) {
	...
	var n = Lt(), r = {
		AuthNextFactor: Rt(),
		AuthSwitchRequest: zt(),
		AuthSwitchRequestMoreData: Bt(),
		AuthSwitchResponse: Vt(),
		BinaryRow: Ht(),
		BinlogDump: Ut(),
		ChangeUser: Wt(),
		CloseStatement: Gt(),
		...
		Execute: Yt(),
		Handshake: Xt(),
		HandshakeResponse: Zt(),
		PrepareStatement: Qt(),
		PreparedStatementHeader: $t(),
		Query: en(),
		RegisterSlave: tn(),
		ResultSetHeader: on(),
		SSLRequest: sn(),
	...
	var n = H().EventEmitter, r = g("timers");
	...
	var n = "sha256_password", r = g("crypto"), { xorRotating: i } = J(), a = Buffer.from([1]), o = 0, s = 1, c = -1;
	function l(e, t, n) {
	...
	var n = "caching_sha2_password", r = g("crypto"), { xor: i, xorRotating: a } = J(), o = Buffer.from([2]), s = Buffer.from([3]), c = Buffer.from([4]), l = 0, u = 1, d = 2, f = -1;
	function p(e) {
	...
	var n = H().EventEmitter, r = g("util"), i = 3e3, a = 0, o = "closed", s = "drained", c = function(e) {
	...
	for (var n = g("util"), r = xn(), i = /[\{\[]/, a = /[\}\]]/, o = /* @__PURE__ */ "do.if.in.for.let.new.try.var.case.else.enum.eval.null.this.true.void.with.await.break.catch.class.const.false.super.throw.while.yield.delete.export.import.public.return.static.switch.typeof.default.extends.finally.package.private.continue.debugger.function.arguments.interface.protected.implements.instanceof.NaN.undefined".split("."), s = {}, c = 0; c < o.length; c++) s[o[c]] = !0;
	var l = function(e) {
	...
	var n = He().default, r = new n({ max: 15e3 });
	function i(e, t, n, r) {
		let i = [
			e,
			typeof n.nestTables,
	...
	var n = Lt(), r = g("timers"), i = g("stream").Readable, a = Z(), o = X(), s = wn(), c = nn(), l = new o.Packet(0, Buffer.allocUnsafe(4), 0, 4), u = class e extends a {
		constructor(e, t) {
	...
	var n = Kt(), r = yn(), i = G(), a = bn(), o = Sn(), s = Cn(), c = [];
	...
	var n = Z(), r = Tn(), i = X(), a = Dn(), o = class e extends n {
		constructor(e, t) {
	...
	var n = Z(), r = X(), i = q(), a = _n(), o = Y(), s = class e extends n {
		constructor(e, t) {
	...
	typings: () => Hn,
	version: () => zn
}), Rn, zn, Bn, Vn, Hn, Un, Wn, Gn, Kn, qn, Jn, Yn, Xn, Zn, Qn, $n, er = d((() => {
	Rn = "mysql2", zn = "3.11.0", Bn = "fast mysql driver. Implements core protocol, prepared statements, ssl and compression in native JS", Vn = "index.js", Hn = "typings/mysql/index", Un = {
	...
	}, Gn = "https://sidorares.github.io/node-mysql2/docs", Kn = [
		"mysql",
		"client",
		"server"
	], qn = [
	...
	}, Yn = { node: ">= 8.0" }, Xn = "Andrey Sidorov <andrey.sidorov@gmail.com>", Zn = {
	...
	var n = tr(), r = nr(), i = { ca: r.proxies }, a = { ca: [...n.defaults, ...r.proxies] };
	e.default = a, t.exports = a, t.exports.proxyBundle = i;
})), ir = /* @__PURE__ */ f(((e) => {
	e["Amazon RDS"] = { ca: rr().ca };
})), ar = /* @__PURE__ */ f(((e, t) => {
	var { URL: n } = g("url"), r = q(), i = yn(), { version: a } = (er(), h(Ln).default), o = null, s = {
		authPlugins: 1,
		authSwitchHandler: 1,
		bigNumberStrings: 1,
		charset: 1,
	...
	t.exports = class e {
		constructor(t) {
			...
			this.maxPacketSize = 0, this.charsetNumber = t.charset ? e.getCharsetNumber(t.charset) : t.charsetNumber || i.UTF8MB4_UNICODE_CI, this.compress = t.compress || !1, this.authPlugins = t.authPlugins, this.authSwitchHandler = t.authSwitchHandler, this.clientFlags = e.mergeFlags(e.getDefaultFlags(t), t.flags || "");
			let n = {
	...
	var n = typeof performance == "object" && performance && typeof performance.now == "function" ? performance : Date, r = typeof AbortController == "function" ? AbortController : class {
		...
		constructor(t = {}) {
			...
			if (this.keyMap = /* @__PURE__ */ new Map(), this.keyList = Array(n).fill(null), this.valList = Array(n).fill(null), this.next = new k(n), this.prev = new k(n), this.head = 0, this.tail = 0, this.free = new _(n), this.initialFill = 1, this.size = 0, typeof p == "function" && (this.dispose = p), typeof g == "function" ? (this.disposeAfter = g, this.disposed = []) : (this.disposeAfter = null, this.disposed = null), this.noDisposeOnSet = !!v, this.noUpdateTTL = !!y, this.noDeleteOnFetchRejection = !!T, this.allowStaleOnFetchRejection = !!D, this.allowStaleOnFetchAbort = !!O, this.ignoreFetchAbort = !!ee, this.maxEntrySize !== 0) {
			...
			if (this.allowStale = !!u || !!re, this.noDeleteOnStaleGet = !!E, this.updateAgeOnGet = !!o, this.updateAgeOnHas = !!l, this.ttlResolution = m(i) || i === 0 ? i : 1, this.ttlAutopurge = !!a, this.ttl = r || ne || 0, this.ttl) {
			...
			re && c("stale", "allowStale"), ne && c("maxAge", "ttl"), te && c("length", "sizeCalculation");
		}
		getRemainingTTL(e) {
	...
	function s(e) {
		e ||= {}, e.placeholder ||= "?";
		let t = 100, n;
		typeof e.cache == "number" && (t = e.cache), typeof e.cache == "object" && (n = e.cache), e.cache !== !1 && !n && (n = new (or())({ max: t }));
		function r(e, t) {
			let n = [];
	...
	var n = g("net"), r = g("tls"), i = g("timers"), a = H().EventEmitter, o = g("stream").Readable, s = Be(), c = ze(), l = He().default, u = It(), d = X(), f = In(), p = ar(), m = Y(), h = 0, _ = null;
	t.exports = class e extends a {
		...
		_resolveNamedPlaceholders(e) {
			...
			if (this.config.namedPlaceholders || e.namedPlaceholders) {
				...
				_ === null && (_ = sr()()), t = _(e.sql, e.values), e.sql = t[0], e.values = t[1];
			}
		}
		query(t, n, r) {
			let i;
	...
	var n = hr().Connection, r = class extends n {
		constructor(e, t) {
	...
	var n = Lt(), r = hr(), i = H().EventEmitter, a = lr(), o = Be(), s = cr();
	function c(e, t) {
		let n = e.length;
	...
	var n = Lt(), r = ur(), i = dr(), a = cr(), o = H().EventEmitter, s = {
		RR() {
			let e = 0;
	...
	var n = g("net"), r = H().EventEmitter, i = cr(), a = ar();
	...
	t.exports = {
		caching_sha2_password: un(),
		mysql_clear_password: fn(),
		mysql_native_password: dn(),
		sha256_password: ln()
	};
})), hr = /* @__PURE__ */ f(((e) => {
	var t = ze(), n = cr(), r = ar(), i = Cn();
	...
	}, e.PoolConnection = lr(), e.authPlugins = mr(), e.escape = t.escape, e.escapeId = t.escapeId, e.format = t.format, e.raw = t.raw, e.__defineGetter__("createConnectionPromise", () => Q().createConnection), e.__defineGetter__("createPoolPromise", () => Q().createPool), e.__defineGetter__("createPoolClusterPromise", () => Q().createPoolCluster), e.__defineGetter__("Types", () => G()), e.__defineGetter__("Charsets", () => yn()), e.__defineGetter__("CharsetToEncoding", () => Y()), e.setMaxParserCache = function(e) {
		i.setMaxCache(e);
	}, e.clearParserCache = function() {
		i.clearCache();
	};
})), Q = /* @__PURE__ */ f(((e) => {
	var t = hr(), n = H().EventEmitter, r = Cn();
	function i(e, t, n) {
	...
	e.createConnection = c, e.createPool = d, e.createPoolCluster = p, e.escape = t.escape, e.escapeId = t.escapeId, e.format = t.format, e.raw = t.raw, e.PromisePool = u, e.PromiseConnection = s, e.PromisePoolConnection = l, e.__defineGetter__("Types", () => G()), e.__defineGetter__("Charsets", () => yn()), e.__defineGetter__("CharsetToEncoding", () => Y()), e.setMaxParserCache = function(e) {
		r.setMaxCache(e);
	}, e.clearParserCache = function() {
		r.clearCache();
	};
...
async function vr(e) {
	let t = await (0, gr.createConnection)(e);
	try {
...
function Sr(e, t, n, r, i, a) {
	if (r === "enum") return yr(e, t);
	let o = br(i, a);
	return o ? `${n} ${o}` : n;
}
function Cr(e) {
	let { tableName: t, columnName: n, columnDefault: r, defaultValueType: i, columnIsNullable: a, columnType: o, columnDataType: s, columnComment: c, columnExtra: l, generationExpression: u } = e, d = Sr(t, n, o, s, l, u), f = xr(r, i);
	return {
		name: n,
		type: {
			type_name: d,
...
async function Dr(e, t) {
	let n = (await e.query("\n    with\n      pk_fk_uniques as (\n        select constraint_name, table_name\n        from information_schema.table_constraints\n        where table_schema = ?\n      )\n    select\n      st.table_name as tableName,\n      case\n        when st.non_unique = 0 then true\n        else false\n        end as isIdxUnique,\n      st.index_name as idxName,\n      st.column_name as columnName,\n      st.sub_part as idxSubPart,\n      st.index_type as idxType,\n      replace(st.expression, '`', '') as idxExpression\n    from information_schema.statistics st\n    where\n      st.table_schema = ?\n      and st.index_name not in (\n        select constraint_name\n        from pk_fk_uniques pfu\n        where pfu.table_name = st.table_name\n      )\n      and st.index_type in ('BTREE', 'HASH')\n    group by\n      st.table_name, st.non_unique, st.index_name, st.column_name, st.sub_part, st.index_type, st.expression\n    order by st.index_name;\n  ", [t, t]))[0].reduce((e, t) => {
		...
		let u = e[l][r], d = wr(o, s, c);
		return d && u.columns.push(d), e;
	}, {}), r = {};
	return Object.keys(n).forEach((e) => {
		r[e] = Le(Object.values(n[e]));
	}), r;
}
...
async function Ar(e, t) {
	...
	return n.forEach((e) => {
		let { constraintName: t, tableName: n, checkClause: a } = e, o = n, s = kr(a);
		if (s.length === 1) {
			let e = s[0];
...
async function Nr(e) {
	let t = await vr(e), { database: n } = t.config;
...
//#endregion
//#region src/connectors/oracle/utils.ts
var $ = "@@@@@@@@", Pr = { outFormat: r.OUT_FORMAT_OBJECT };
function Fr(e) {
...
//#endregion
//#region src/connectors/oracle/constraints.ts
async function Ir(e) {
	let t = `
    ...
    ORDER BY
      ...
      ac.CONSTRAINT_NAME
  `, n = {}, r = {}, i = {};
	return (await e.execute(t, [], Pr)).rows?.forEach((e) => {
		let { constraint_name: t, table_name: a, columns: o, column_count: s, check_expression: c, constraint_type: l } = e, u = a, d = t || "", f = (o || "").split($), p = s || 1, m = l, h = c || null;
		if (m === "C" && h && p > 1) {
			i[u] || (i[u] = []);
			let e = {
				name: d,
...
//#endregion
//#region src/connectors/oracle/indexes.ts
async function Lr(e) {
...
//#endregion
//#region src/connectors/oracle/refs.ts
async function Rr(e) {
	let t = [], n = `
    SELECT
    ...
    ORDER BY
      ...
      c.CONSTRAINT_NAME
  `;
	return (await e.execute(n, [], Pr)).rows?.forEach((e) => {
...
//#endregion
//#region src/connectors/oracle/tables.ts
async function zr(e) {
...
function Vr(e) {
	let { column_name: t, data_type: n, data_length: r, data_precision: i, data_scale: a, identity_increment: o, is_nullable: s, data_default: c, column_comment: l } = e, u = Br(c), d = c && !o ? Hr(c, u) : null;
	return {
		name: t,
		type: {
			type_name: Qr(n, r, i, a),
			schemaName: null
		},
		dbdefault: d,
		not_null: !s,
...
var Ur = new Set([
	...
	"national char"
]), Wr = new Set(["float"]), Gr = "timestamp with local time zone", Kr = "timestamp with time zone", qr = "timestamp", Jr = "interval year to month", Yr = "interval day to second", Xr = new Set([
	"number",
	"numeric",
	"decimal",
	"dec"
...
function Qr(e, t, n, r) {
	let i = Zr(e);
	return i === Gr ? r === null ? i : `timestamp (${r}) with local time zone` : i === Kr ? r === null ? i : `timestamp (${r}) with time zone` : i === qr ? r === null ? i : `timestamp (${r})` : i === Jr ? n === null ? i : `interval year (${n}) to month` : i === Yr ? n !== null && r !== null ? `interval day (${n}) to second (${r})` : n === null ? r === null ? i : `interval day to second (${r})` : `interval day (${n}) to second` : Ur.has(i) ? t ? `${i}(${t})` : i : Wr.has(i) ? n === null ? i : `${i}(${n})` : Xr.has(i) ? n !== null && r !== null ? `${i}(${n}, ${r})` : n === null ? i : `${i}(${n})` : i;
}
//#endregion
//#region src/connectors/oracle/index.ts
var $r = async (e, t, n) => {
	let r = await i({
		username: e,
		password: t,
...
async function ei(e) {
	let { username: t, password: n, dbidentifier: r } = Fr(e), i = await $r(t, n, r), a = zr(i), o = Ir(i), s = Rr(i), c = Lr(i), l = await Promise.all([
		a,
		o,
		s,
		c
...
//#endregion
//#region src/connectors/postgres/index.ts
var ti = async (e) => {
	let t = new a(e);
	try {
		return await t.connect(), await t.query("SELECT 1"), t;
...
}, ni = (e) => e === "YES", ri = (e, t, n, r, i) => e === "ARRAY" ? `${t.slice(1, t.length)}[]` : n ? `${t}(${n})` : r && i ? `${t}(${r},${i})` : t, ii = (e, t, n) => {
	if (e === "ARRAY") return {
		type: n,
	...
	let { column_name: t, data_type: n, character_maximum_length: r, numeric_precision: i, numeric_scale: a, udt_schema: o, udt_name: s, identity_increment: c, is_nullable: l, column_default: u, default_type: d, column_comment: f } = e, p = u && d !== "increment" ? ii(n, u, d) : null;
	return {
		name: t,
		type: n === "USER-DEFINED" ? {
			type_name: s,
  ...
  `, r = (await e.query(n)).rows.reduce((e, t) => {
	...
	let { connectionString: t, schemas: n } = ce(e, "jdbc"), r = await ti(t);
	try {
		let e = oi(r, n), t = ci(r, n), i = si(r, n), a = li(r, n), o = await Promise.all([
			e,
			t,
			i,
			a
	...
	return t;
}, fi = async (e) => new Promise((t, n) => {
	console.log("Attempting to connect..."), e.connect((e) => {
		e ? n(e) : t();
	});
}), pi = (e, t) => new Promise((n, r) => {
	...
	"DEBUG",
	"TRACE"
].includes(e), hi = async (e) => {
	let t = mi(e.LOG_LEVEL) ? e.LOG_LEVEL : "INFO", n = e.IS_DEBUG_MODE === "true";
	o.configure({
		logLevel: t,
	...
	let i = {
		...
		timeout: 1e4,
		...r
	}, a = o.createConnection(i);
	return await fi(a), await pi(a, "SELECT CURRENT_VERSION();"), a;
}, gi = (e) => e === "YES", _i = (e, t, n, r) => t ? `${e}(${t})` : n && r ? `${e}(${n},${r})` : e, vi = (e, t) => t === "string" ? {
	type: t,
	value: e.slice(1, -1)
} : {
	type: t,
	...
	let { COLUMN_NAME: t, DATA_TYPE: n, CHARACTER_MAXIMUM_LENGTH: r, NUMERIC_PRECISION: i, NUMERIC_SCALE: a, IDENTITY_INCREMENT: o, IS_NULLABLE: s, COLUMN_DEFAULT: c, DEFAULT_TYPE: l, COLUMN_COMMENT: u } = e, d = c ? vi(c, l) : null;
	return {
		name: t,
		type: {
			type_name: _i(n, r, i, a),
			schemaName: null
		},
		dbdefault: d,
		not_null: !gi(s),
  ...
  `, a = await pi(e, r), o = await pi(e, i), s = xi(a, n, "primary"), c = xi(o, n, "unique"), { indexes: l, tableConstraints: u } = [Object.values(s), Object.values(c)].flat().reduce((e, t) => {
	...
	let t = di(e), n = await hi(t);
	if (n instanceof Error) throw n;
	let r = t.SCHEMAS ? M(t.SCHEMAS) : [], i = t.DATABASE, a = bi(n, r), o = Si(n, i, r), s = await Promise.all([a, o]);
	n.destroy((e) => {
		if (e) throw e;
...
}, wi = /* @__PURE__ */ p({ fetchSchemaJson: () => Ti }), Ti = async (e, t) => {
	switch (t) {
		case "postgres": return ui(e);
		case "mssql": return he(e);
		case "mysql": return Nr(e);
		case "snowflake": return Ci(e);
		case "bigquery": return k(e);
		case "oracle": return ei(e);
		default: throw Error(`Unsupported database type: ${t}`);
	}
};
//#endregion
export { wi as connector };
